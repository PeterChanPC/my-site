...
#define LOW_PRECISION`),e}function Kw(t){let e="SHADOWMAP_TYPE_BASIC";return t.shadowMapType===Gm?e="SHADOWMAP_TYPE_PCF":t.shadowMapType===Wm?e="SHADOWMAP_TYPE_PCF_SOFT":t.shadowMapType===ci&&(e="SHADOWMAP_TYPE_VSM"),e}function Zw(t){let e="ENVMAP_TYPE_CUBE";if(t.envMap)switch(t.envMapMode){case hs:case ds:e="ENVMAP_TYPE_CUBE";break;case zo:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Jw(t){let e="ENVMAP_MODE_REFLECTION";if(t.envMap)switch(t.envMapMode){case ds:e="ENVMAP_MODE_REFRACTION";break}return e}function Qw(t){let e="ENVMAP_BLENDING_NONE";if(t.envMap)switch(t.combine){case Ho:e="ENVMAP_BLENDING_MULTIPLY";break;case vy:e="ENVMAP_BLENDING_MIX";break;case xy:e="ENVMAP_BLENDING_ADD";break}return e}function eA(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),112)),texelHeight:i,maxMip:n}}function tA(t,e,n,i){const r=t.getContext(),s=n.defines;let a=n.vertexShader,o=n.fragmentShader;const l=Kw(n),c=Zw(n),u=Jw(n),f=Qw(n),d=eA(n),p=Vw(n),_=Gw(s),x=r.createProgram();let g,h,M=n.glslVersion?"#version "+n.glslVersion+`
...
`].filter(Ns).join(`
`)),a=tu(a),a=Fd(a,n),a=Od(a,n),o=tu(o),o=Fd(o,n),o=Od(o,n),a=Bd(a),o=Bd(o),n.isRawShaderMaterial!==!0&&(M=`#version 300 es

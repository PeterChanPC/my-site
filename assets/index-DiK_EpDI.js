...
* @license MIT
**/function Pu(t){const e=Object.create(null);for(const n of t.split(","))e[n]=1;return n=>n in e}const vt={},es=[],ni=()=>{},Fp=()=>!1,Ia=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&(t.charCodeAt(2)>122||t.charCodeAt(2)<97),Lu=t=>t.startsWith("onUpdate:"),tn=Object.assign,Iu=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},V_=Object.prototype.hasOwnProperty,dt=(t,e)=>V_.call(t,e),Xe=Array.isArray,ts=t=>Da(t)==="[object Map]",Bp=t=>Da(t)==="[object Set]",qe=t=>typeof t=="function",Ot=t=>typeof t=="string",Ii=t=>typeof t=="symbol",Tt=t=>t!==null&&typeof t=="object",kp=t=>(Tt(t)||qe(t))&&qe(t.then)&&qe(t.catch),Hp=Object.prototype.toString,Da=t=>Hp.call(t),G_=t=>Da(t).slice(8,-1),zp=t=>Da(t)==="[object Object]",Du=t=>Ot(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Os=Pu(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Ua=t=>{const e=Object.create(null);return(n=>e[n]||(e[n]=t(n)))},W_=/-\w/g,Dn=Ua(t=>t.replace(W_,e=>e.slice(1).toUpperCase())),X_=/\B([A-Z])/g,Pr=Ua(t=>t.replace(X_,"-$1").toLowerCase()),Na=Ua(t=>t.charAt(0).toUpperCase()+t.slice(1)),ul=Ua(t=>t?`on${Na(t)}`:""),qi=(t,e)=>!Object.is(t,e),na=(t,...e)=>{for(let n=0;n<t.length;n++)t[n](...e)},Vp=(t,e,n,i=!1)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,writable:i,value:n})},hc=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let Hf;const Oa=()=>Hf||(Hf=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Fa(t){if(Xe(t)){const e={};for(let n=0;n<t.length;n++){const i=t[n],r=Ot(i)?Y_(i):Fa(i);if(r)for(const s in r)e[s]=r[s]}return e}else if(Ot(t)||Tt(t))return t}const $_=/;(?![^(]*\))/g,q_=/:([^]+)/,j_=/\/\*[^]*?\*\//g;function Y_(t){const e={};return t.replace(j_,"").split($_).forEach(n=>{if(n){const i=n.split(q_);i.length>1&&(e[i[0].trim()]=i[1].trim())}}),e}function bn(t){let e="";if(Ot(t))e=t;else if(Xe(t))for(let n=0;n<t.length;n++){const i=bn(t[n]);i&&(e+=i+" ")}else if(Tt(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const K_="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Z_=Pu(K_);function Gp(t){return!!t||t===""}const Wp=t=>!!(t&&t.__v_isRef===!0),cn=t=>Ot(t)?t:t==null?"":Xe(t)||Tt(t)&&(t.toString===Hp||!qe(t.toString))?Wp(t)?cn(t.value):JSON.stringify(t,Xp,2):String(t),Xp=(t,e)=>Wp(e)?Xp(t,e.value):ts(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[i,r],s)=>(n[fl(i,s)+" =>"]=r,n),{})}:Bp(e)?{[`Set(${e.size})`]:[...e.values()].map(n=>fl(n))}:Ii(e)?fl(e):Tt(e)&&!Xe(e)&&!zp(e)?String(e):e,fl=(t,e="")=>{var n;return Ii(t)?`Symbol(${(n=t.description)!=null?n:e})`:t};/**
* @vue/reactivity v3.5.21
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Zt;class $p{constructor(e=!1){this.detached=e,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.parent=Zt,!e&&Zt&&(this.index=(Zt.scopes||(Zt.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,n;if(this.scopes)for(e=0,n=this.scopes.length;e<n;e++)this.scopes[e].pause();for(e=0,n=this.effects.length;e<n;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,n;if(this.scopes)for(e=0,n=this.scopes.length;e<n;e++)this.scopes[e].resume();for(e=0,n=this.effects.length;e<n;e++)this.effects[e].resume()}}run(e){if(this._active){const n=Zt;try{return Zt=this,e()}finally{Zt=n}}}on(){++this._on===1&&(this.prevScope=Zt,Zt=this)}off(){this._on>0&&--this._on===0&&(Zt=this.prevScope,this.prevScope=void 0)}stop(e){if(this._active){this._active=!1;let n,i;for(n=0,i=this.effects.length;n<i;n++)this.effects[n].stop();for(this.effects.length=0,n=0,i=this.cleanups.length;n<i;n++)this.cleanups[n]();if(this.cleanups.length=0,this.scopes){for(n=0,i=this.scopes.length;n<i;n++)this.scopes[n].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!e){const r=this.parent.scopes.pop();r&&r!==this&&(this.parent.scopes[this.index]=r,r.index=this.index)}this.parent=void 0}}}function Uu(t){return new $p(t)}function qp(){return Zt}function J_(t,e=!1){Zt&&Zt.cleanups.push(t)}let St;const hl=new WeakSet;class jp{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,Zt&&Zt.active&&Zt.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,hl.has(this)&&(hl.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Kp(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,zf(this),Zp(this);const e=St,n=Vn;St=this,Vn=!0;try{return this.fn()}finally{Jp(this),St=e,Vn=n,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)Fu(e);this.deps=this.depsTail=void 0,zf(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?hl.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){dc(this)&&this.run()}get dirty(){return dc(this)}}let Yp=0,Fs,Bs;function Kp(t,e=!1){if(t.flags|=8,e){t.next=Bs,Bs=t;return}t.next=Fs,Fs=t}function Nu(){Yp++}function Ou(){if(--Yp>0)return;if(Bs){let e=Bs;for(Bs=void 0;e;){const n=e.next;e.next=void 0,e.flags&=-9,e=n}}let t;for(;Fs;){let e=Fs;for(Fs=void 0;e;){const n=e.next;if(e.next=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(i){t||(t=i)}e=n}}if(t)throw t}function Zp(t){for(let e=t.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function Jp(t){let e,n=t.depsTail,i=n;for(;i;){const r=i.prevDep;i.version===-1?(i===n&&(n=r),Fu(i),Q_(i)):e=i,i.dep.activeLink=i.prevActiveLink,i.prevActiveLink=void 0,i=r}t.deps=e,t.depsTail=n}function dc(t){for(let e=t.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&(Qp(e.dep.computed)||e.dep.version!==e.version))return!0;return!!t._dirty}function Qp(t){if(t.flags&4&&!(t.flags&16)||(t.flags&=-17,t.globalVersion===Xs)||(t.globalVersion=Xs,!t.isSSR&&t.flags&128&&(!t.deps&&!t._dirty||!dc(t))))return;t.flags|=2;const e=t.dep,n=St,i=Vn;St=t,Vn=!0;try{Zp(t);const r=t.fn(t._value);(e.version===0||qi(r,t._value))&&(t.flags|=128,t._value=r,e.version++)}catch(r){throw e.version++,r}finally{St=n,Vn=i,Jp(t),t.flags&=-3}}function Fu(t,e=!1){const{dep:n,prevSub:i,nextSub:r}=t;if(i&&(i.nextSub=r,t.prevSub=void 0),r&&(r.prevSub=i,t.nextSub=void 0),n.subs===t&&(n.subs=i,!i&&n.computed)){n.computed.flags&=-5;for(let s=n.computed.deps;s;s=s.nextDep)Fu(s,!0)}!e&&!--n.sc&&n.map&&n.map.delete(n.key)}function Q_(t){const{prevDep:e,nextDep:n}=t;e&&(e.nextDep=n,t.prevDep=void 0),n&&(n.prevDep=e,t.nextDep=void 0)}let Vn=!0;const em=[];function Ci(){em.push(Vn),Vn=!1}function Pi(){const t=em.pop();Vn=t===void 0?!0:t}function zf(t){const{cleanup:e}=t;if(t.cleanup=void 0,e){const n=St;St=void 0;try{e()}finally{St=n}}}let Xs=0;class e0{constructor(e,n){this.sub=e,this.dep=n,this.version=n.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Bu{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(e){if(!St||!Vn||St===this.computed)return;let n=this.activeLink;if(n===void 0||n.sub!==St)n=this.activeLink=new e0(St,this),St.deps?(n.prevDep=St.depsTail,St.depsTail.nextDep=n,St.depsTail=n):St.deps=St.depsTail=n,tm(n);else if(n.version===-1&&(n.version=this.version,n.nextDep)){const i=n.nextDep;i.prevDep=n.prevDep,n.prevDep&&(n.prevDep.nextDep=i),n.prevDep=St.depsTail,n.nextDep=void 0,St.depsTail.nextDep=n,St.depsTail=n,St.deps===n&&(St.deps=i)}return n}trigger(e){this.version++,Xs++,this.notify(e)}notify(e){Nu();try{for(let n=this.subs;n;n=n.prevSub)n.sub.notify()&&n.sub.dep.notify()}finally{Ou()}}}function tm(t){if(t.dep.sc++,t.sub.flags&4){const e=t.dep.computed;if(e&&!t.dep.subs){e.flags|=20;for(let i=e.deps;i;i=i.nextDep)tm(i)}const n=t.dep.subs;n!==t&&(t.prevSub=n,n&&(n.nextSub=t)),t.dep.subs=t}}const ga=new WeakMap,br=Symbol(""),pc=Symbol(""),$s=Symbol("");function Jt(t,e,n){if(Vn&&St){let i=ga.get(t);i||ga.set(t,i=new Map);let r=i.get(n);r||(i.set(n,r=new Bu),r.map=i,r.key=n),r.track()}}function xi(t,e,n,i,r,s){const o=ga.get(t);if(!o){Xs++;return}const a=l=>{l&&l.trigger()};if(Nu(),e==="clear")o.forEach(a);else{const l=Xe(t),c=l&&Du(n);if(l&&n==="length"){const u=Number(i);o.forEach((f,h)=>{(h==="length"||h===$s||!Ii(h)&&h>=u)&&a(f)})}else switch((n!==void 0||o.has(void 0))&&a(o.get(n)),c&&a(o.get($s)),e){case"add":l?c&&a(o.get("length")):(a(o.get(br)),ts(t)&&a(o.get(pc)));break;case"delete":l||(a(o.get(br)),ts(t)&&a(o.get(pc)));break;case"set":ts(t)&&a(o.get(br));break}}Ou()}function t0(t,e){const n=ga.get(t);return n&&n.get(e)}function Dr(t){const e=st(t);return e===t?e:(Jt(e,"iterate",$s),In(t)?e:e.map(Xt))}function Ba(t){return Jt(t=st(t),"iterate",$s),t}const n0={__proto__:null,[Symbol.iterator](){return dl(this,Symbol.iterator,Xt)},concat(...t){return Dr(this).concat(...t.map(e=>Xe(e)?Dr(e):e))},entries(){return dl(this,"entries",t=>(t[1]=Xt(t[1]),t))},every(t,e){return ci(this,"every",t,e,void 0,arguments)},filter(t,e){return ci(this,"filter",t,e,n=>n.map(Xt),arguments)},find(t,e){return ci(this,"find",t,e,Xt,arguments)},findIndex(t,e){return ci(this,"findIndex",t,e,void 0,arguments)},findLast(t,e){return ci(this,"findLast",t,e,Xt,arguments)},findLastIndex(t,e){return ci(this,"findLastIndex",t,e,void 0,arguments)},forEach(t,e){return ci(this,"forEach",t,e,void 0,arguments)},includes(...t){return pl(this,"includes",t)},indexOf(...t){return pl(this,"indexOf",t)},join(t){return Dr(this).join(t)},lastIndexOf(...t){return pl(this,"lastIndexOf",t)},map(t,e){return ci(this,"map",t,e,void 0,arguments)},pop(){return bs(this,"pop")},push(...t){return bs(this,"push",t)},reduce(t,...e){return Vf(this,"reduce",t,e)},reduceRight(t,...e){return Vf(this,"reduceRight",t,e)},shift(){return bs(this,"shift")},some(t,e){return ci(this,"some",t,e,void 0,arguments)},splice(...t){return bs(this,"splice",t)},toReversed(){return Dr(this).toReversed()},toSorted(t){return Dr(this).toSorted(t)},toSpliced(...t){return Dr(this).toSpliced(...t)},unshift(...t){return bs(this,"unshift",t)},values(){return dl(this,"values",Xt)}};function dl(t,e,n){const i=Ba(t),r=i[e]();return i!==t&&!In(t)&&(r._next=r.next,r.next=()=>{const s=r._next();return s.value&&(s.value=n(s.value)),s}),r}const i0=Array.prototype;function ci(t,e,n,i,r,s){const o=Ba(t),a=o!==t&&!In(t),l=o[e];if(l!==i0[e]){const f=l.apply(t,s);return a?Xt(f):f}let c=n;o!==t&&(a?c=function(f,h){return n.call(this,Xt(f),h,t)}:n.length>2&&(c=function(f,h){return n.call(this,f,h,t)}));const u=l.call(o,c,i);return a&&r?r(u):u}function Vf(t,e,n,i){const r=Ba(t);let s=n;return r!==t&&(In(t)?n.length>3&&(s=function(o,a,l){return n.call(this,o,a,l,t)}):s=function(o,a,l){return n.call(this,o,Xt(a),l,t)}),r[e](s,...i)}function pl(t,e,n){const i=st(t);Jt(i,"iterate",$s);const r=i[e](...n);return(r===-1||r===!1)&&zu(n[0])?(n[0]=st(n[0]),i[e](...n)):r}function bs(t,e,n=[]){Ci(),Nu();const i=st(t)[e].apply(t,n);return Ou(),Pi(),i}const r0=Pu("__proto__,__v_isRef,__isVue"),nm=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(Ii));function s0(t){Ii(t)||(t=String(t));const e=st(this);return Jt(e,"has",t),e.hasOwnProperty(t)}class im{constructor(e=!1,n=!1){this._isReadonly=e,this._isShallow=n}get(e,n,i){if(n==="__v_skip")return e.__v_skip;const r=this._isReadonly,s=this._isShallow;if(n==="__v_isReactive")return!r;if(n==="__v_isReadonly")return r;if(n==="__v_isShallow")return s;if(n==="__v_raw")return i===(r?s?m0:am:s?om:sm).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(i)?e:void 0;const o=Xe(e);if(!r){let l;if(o&&(l=n0[n]))return l;if(n==="hasOwnProperty")return s0}const a=Reflect.get(e,n,Lt(e)?e:i);return(Ii(n)?nm.has(n):r0(n))||(r||Jt(e,"get",n),s)?a:Lt(a)?o&&Du(n)?a:a.value:Tt(a)?r?cm(a):ho(a):a}}class rm extends im{constructor(e=!1){super(!1,e)}set(e,n,i,r){let s=e[n];if(!this._isShallow){const l=Zi(s);if(!In(i)&&!Zi(i)&&(s=st(s),i=st(i)),!Xe(e)&&Lt(s)&&!Lt(i))return l||(s.value=i),!0}const o=Xe(e)&&Du(n)?Number(n)<e.length:dt(e,n),a=Reflect.set(e,n,i,Lt(e)?e:r);return e===st(r)&&(o?qi(i,s)&&xi(e,"set",n,i):xi(e,"add",n,i)),a}deleteProperty(e,n){const i=dt(e,n);e[n];const r=Reflect.deleteProperty(e,n);return r&&i&&xi(e,"delete",n,void 0),r}has(e,n){const i=Reflect.has(e,n);return(!Ii(n)||!nm.has(n))&&Jt(e,"has",n),i}ownKeys(e){return Jt(e,"iterate",Xe(e)?"length":br),Reflect.ownKeys(e)}}class o0 extends im{constructor(e=!1){super(!0,e)}set(e,n){return!0}deleteProperty(e,n){return!0}}const a0=new rm,l0=new o0,c0=new rm(!0);const mc=t=>t,Ro=t=>Reflect.getPrototypeOf(t);function u0(t,e,n){return function(...i){const r=this.__v_raw,s=st(r),o=ts(s),a=t==="entries"||t===Symbol.iterator&&o,l=t==="keys"&&o,c=r[t](...i),u=n?mc:e?_a:Xt;return!e&&Jt(s,"iterate",l?pc:br),{next(){const{value:f,done:h}=c.next();return h?{value:f,done:h}:{value:a?[u(f[0]),u(f[1])]:u(f),done:h}},[Symbol.iterator](){return this}}}}function Co(t){return function(...e){return t==="delete"?!1:t==="clear"?void 0:this}}function f0(t,e){const n={get(r){const s=this.__v_raw,o=st(s),a=st(r);t||(qi(r,a)&&Jt(o,"get",r),Jt(o,"get",a));const{has:l}=Ro(o),c=e?mc:t?_a:Xt;if(l.call(o,r))return c(s.get(r));if(l.call(o,a))return c(s.get(a));s!==o&&s.get(r)},get size(){const r=this.__v_raw;return!t&&Jt(st(r),"iterate",br),r.size},has(r){const s=this.__v_raw,o=st(s),a=st(r);return t||(qi(r,a)&&Jt(o,"has",r),Jt(o,"has",a)),r===a?s.has(r):s.has(r)||s.has(a)},forEach(r,s){const o=this,a=o.__v_raw,l=st(a),c=e?mc:t?_a:Xt;return!t&&Jt(l,"iterate",br),a.forEach((u,f)=>r.call(s,c(u),c(f),o))}};return tn(n,t?{add:Co("add"),set:Co("set"),delete:Co("delete"),clear:Co("clear")}:{add(r){!e&&!In(r)&&!Zi(r)&&(r=st(r));const s=st(this);return Ro(s).has.call(s,r)||(s.add(r),xi(s,"add",r,r)),this},set(r,s){!e&&!In(s)&&!Zi(s)&&(s=st(s));const o=st(this),{has:a,get:l}=Ro(o);let c=a.call(o,r);c||(r=st(r),c=a.call(o,r));const u=l.call(o,r);return o.set(r,s),c?qi(s,u)&&xi(o,"set",r,s):xi(o,"add",r,s),this},delete(r){const s=st(this),{has:o,get:a}=Ro(s);let l=o.call(s,r);l||(r=st(r),l=o.call(s,r)),a&&a.call(s,r);const c=s.delete(r);return l&&xi(s,"delete",r,void 0),c},clear(){const r=st(this),s=r.size!==0,o=r.clear();return s&&xi(r,"clear",void 0,void 0),o}}),["keys","values","entries",Symbol.iterator].forEach(r=>{n[r]=u0(r,t,e)}),n}function ku(t,e){const n=f0(t,e);return(i,r,s)=>r==="__v_isReactive"?!t:r==="__v_isReadonly"?t:r==="__v_raw"?i:Reflect.get(dt(n,r)&&r in i?n:i,r,s)}const h0={get:ku(!1,!1)},d0={get:ku(!1,!0)},p0={get:ku(!0,!1)};const sm=new WeakMap,om=new WeakMap,am=new WeakMap,m0=new WeakMap;function g0(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function _0(t){return t.__v_skip||!Object.isExtensible(t)?0:g0(G_(t))}function ho(t){return Zi(t)?t:Hu(t,!1,a0,h0,sm)}function lm(t){return Hu(t,!1,c0,d0,om)}function cm(t){return Hu(t,!0,l0,p0,am)}function Hu(t,e,n,i,r){if(!Tt(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const s=_0(t);if(s===0)return t;const o=r.get(t);if(o)return o;const a=new Proxy(t,s===2?i:n);return r.set(t,a),a}function ji(t){return Zi(t)?ji(t.__v_raw):!!(t&&t.__v_isReactive)}function Zi(t){return!!(t&&t.__v_isReadonly)}function In(t){return!!(t&&t.__v_isShallow)}function zu(t){return t?!!t.__v_raw:!1}function st(t){const e=t&&t.__v_raw;return e?st(e):t}function Vu(t){return!dt(t,"__v_skip")&&Object.isExtensible(t)&&Vp(t,"__v_skip",!0),t}const Xt=t=>Tt(t)?ho(t):t,_a=t=>Tt(t)?cm(t):t;function Lt(t){return t?t.__v_isRef===!0:!1}function bt(t){return um(t,!1)}function Gu(t){return um(t,!0)}function um(t,e){return Lt(t)?t:new v0(t,e)}class v0{constructor(e,n){this.dep=new Bu,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=n?e:st(e),this._value=n?e:Xt(e),this.__v_isShallow=n}get value(){return this.dep.track(),this._value}set value(e){const n=this._rawValue,i=this.__v_isShallow||In(e)||Zi(e);e=i?e:st(e),qi(e,n)&&(this._rawValue=e,this._value=i?e:Xt(e),this.dep.trigger())}}function pn(t){return Lt(t)?t.value:t}const x0={get:(t,e,n)=>e==="__v_raw"?t:pn(Reflect.get(t,e,n)),set:(t,e,n,i)=>{const r=t[e];return Lt(r)&&!Lt(n)?(r.value=n,!0):Reflect.set(t,e,n,i)}};function fm(t){return ji(t)?t:new Proxy(t,x0)}function S0(t){const e=Xe(t)?new Array(t.length):{};for(const n in t)e[n]=E0(t,n);return e}class y0{constructor(e,n,i){this._object=e,this._key=n,this._defaultValue=i,this.__v_isRef=!0,this._value=void 0}get value(){const e=this._object[this._key];return this._value=e===void 0?this._defaultValue:e}set value(e){this._object[this._key]=e}get dep(){return t0(st(this._object),this._key)}}function E0(t,e,n){const i=t[e];return Lt(i)?i:new y0(t,e,n)}class M0{constructor(e,n,i){this.fn=e,this.setter=n,this._value=void 0,this.dep=new Bu(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Xs-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!n,this.isSSR=i}notify(){if(this.flags|=16,!(this.flags&8)&&St!==this)return Kp(this,!0),!0}get value(){const e=this.dep.track();return Qp(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function b0(t,e,n=!1){let i,r;return qe(t)?i=t:(i=t.get,r=t.set),new M0(i,r,n)}const Po={},va=new WeakMap;let mr;function T0(t,e=!1,n=mr){if(n){let i=va.get(n);i||va.set(n,i=[]),i.push(t)}}function A0(t,e,n=vt){const{immediate:i,deep:r,once:s,scheduler:o,augmentJob:a,call:l}=n,c=x=>r?x:In(x)||r===!1||r===0?Si(x,1):Si(x);let u,f,h,p,_=!1,v=!1;if(Lt(t)?(f=()=>t.value,_=In(t)):ji(t)?(f=()=>c(t),_=!0):Xe(t)?(v=!0,_=t.some(x=>ji(x)||In(x)),f=()=>t.map(x=>{if(Lt(x))return x.value;if(ji(x))return c(x);if(qe(x))return l?l(x,2):x()})):qe(t)?e?f=l?()=>l(t,2):t:f=()=>{if(h){Ci();try{h()}finally{Pi()}}const x=mr;mr=u;try{return l?l(t,3,[p]):t(p)}finally{mr=x}}:f=ni,e&&r){const x=f,P=r===!0?1/0:r;f=()=>Si(x(),P)}const m=qp(),d=()=>{u.stop(),m&&m.active&&Iu(m.effects,u)};if(s&&e){const x=e;e=(...P)=>{x(...P),d()}}let S=v?new Array(t.length).fill(Po):Po;const E=x=>{if(!(!(u.flags&1)||!u.dirty&&!x))if(e){const P=u.run();if(r||_||(v?P.some((I,R)=>qi(I,S[R])):qi(P,S))){h&&h();const I=mr;mr=u;try{const R=[P,S===Po?void 0:v&&S[0]===Po?[]:S,p];S=P,l?l(e,3,R):e(...R)}finally{mr=I}}}else u.run()};return a&&a(E),u=new jp(f),u.scheduler=o?()=>o(E,!1):E,p=x=>T0(x,!1,u),h=u.onStop=()=>{const x=va.get(u);if(x){if(l)l(x,4);else for(const P of x)P();va.delete(u)}},e?i?E(!0):S=u.run():o?o(E.bind(null,!0),!0):u.run(),d.pause=u.pause.bind(u),d.resume=u.resume.bind(u),d.stop=d,d}function Si(t,e=1/0,n){if(e<=0||!Tt(t)||t.__v_skip||(n=n||new Map,(n.get(t)||0)>=e))return t;if(n.set(t,e),e--,Lt(t))Si(t.value,e,n);else if(Xe(t))for(let i=0;i<t.length;i++)Si(t[i],e,n);else if(Bp(t)||ts(t))t.forEach(i=>{Si(i,e,n)});else if(zp(t)){for(const i in t)Si(t[i],e,n);for(const i of Object.getOwnPropertySymbols(t))Object.prototype.propertyIsEnumerable.call(t,i)&&Si(t[i],e,n)}return t}/**
* @vue/runtime-core v3.5.21
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function po(t,e,n,i){try{return i?t(...i):t()}catch(r){ka(r,e,n)}}function oi(t,e,n,i){if(qe(t)){const r=po(t,e,n,i);return r&&kp(r)&&r.catch(s=>{ka(s,e,n)}),r}if(Xe(t)){const r=[];for(let s=0;s<t.length;s++)r.push(oi(t[s],e,n,i));return r}}function ka(t,e,n,i=!0){const r=e?e.vnode:null,{errorHandler:s,throwUnhandledErrorInProduction:o}=e&&e.appContext.config||vt;if(e){let a=e.parent;const l=e.proxy,c=`https://vuejs.org/error-reference/#runtime-${n}`;for(;a;){const u=a.ec;if(u){for(let f=0;f<u.length;f++)if(u[f](t,l,c)===!1)return}a=a.parent}if(s){Ci(),po(s,null,10,[t,l,c]),Pi();return}}w0(t,n,r,i,o)}function w0(t,e,n,i=!0,r=!1){if(r)throw t;console.error(t)}const an=[];let Zn=-1;const ns=[];let Gi=null,Yr=0;const hm=Promise.resolve();let xa=null;function Wu(t){const e=xa||hm;return t?e.then(this?t.bind(this):t):e}function R0(t){let e=Zn+1,n=an.length;for(;e<n;){const i=e+n>>>1,r=an[i],s=qs(r);s<t||s===t&&r.flags&2?e=i+1:n=i}return e}function Xu(t){if(!(t.flags&1)){const e=qs(t),n=an[an.length-1];!n||!(t.flags&2)&&e>=qs(n)?an.push(t):an.splice(R0(e),0,t),t.flags|=1,dm()}}function dm(){xa||(xa=hm.then(mm))}function C0(t){Xe(t)?ns.push(...t):Gi&&t.id===-1?Gi.splice(Yr+1,0,t):t.flags&1||(ns.push(t),t.flags|=1),dm()}function Gf(t,e,n=Zn+1){for(;n<an.length;n++){const i=an[n];if(i&&i.flags&2){if(t&&i.id!==t.uid)continue;an.splice(n,1),n--,i.flags&4&&(i.flags&=-2),i(),i.flags&4||(i.flags&=-2)}}}function pm(t){if(ns.length){const e=[...new Set(ns)].sort((n,i)=>qs(n)-qs(i));if(ns.length=0,Gi){Gi.push(...e);return}for(Gi=e,Yr=0;Yr<Gi.length;Yr++){const n=Gi[Yr];n.flags&4&&(n.flags&=-2),n.flags&8||n(),n.flags&=-2}Gi=null,Yr=0}}const qs=t=>t.id==null?t.flags&2?-1:1/0:t.id;function mm(t){try{for(Zn=0;Zn<an.length;Zn++){const e=an[Zn];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),po(e,e.i,e.i?15:14),e.flags&4||(e.flags&=-2))}}finally{for(;Zn<an.length;Zn++){const e=an[Zn];e&&(e.flags&=-2)}Zn=-1,an.length=0,pm(),xa=null,(an.length||ns.length)&&mm()}}let $t=null,gm=null;function Sa(t){const e=$t;return $t=t,gm=t&&t.type.__scopeId||null,e}function Ft(t,e=$t,n){if(!e||t._n)return t;const i=(...r)=>{i._d&&ba(-1);const s=Sa(e);let o;try{o=t(...r)}finally{Sa(s),i._d&&ba(1)}return o};return i._n=!0,i._c=!0,i._d=!0,i}function Wf(t,e){if($t===null)return t;const n=Wa($t),i=t.dirs||(t.dirs=[]);for(let r=0;r<e.length;r++){let[s,o,a,l=vt]=e[r];s&&(qe(s)&&(s={mounted:s,updated:s}),s.deep&&Si(o),i.push({dir:s,instance:n,value:o,oldValue:void 0,arg:a,modifiers:l}))}return t}function ar(t,e,n,i){const r=t.dirs,s=e&&e.dirs;for(let o=0;o<r.length;o++){const a=r[o];s&&(a.oldValue=s[o].value);let l=a.dir[i];l&&(Ci(),oi(l,n,8,[t.el,a,t,e]),Pi())}}const P0=Symbol("_vte"),L0=t=>t.__isTeleport,I0=Symbol("_leaveCb");function $u(t,e){t.shapeFlag&6&&t.component?(t.transition=e,$u(t.component.subTree,e)):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}function Gt(t,e){return qe(t)?tn({name:t.name},e,{setup:t}):t}function _m(t){t.ids=[t.ids[0]+t.ids[2]+++"-",0,0]}function Xf(t){const e=Ji(),n=Gu(null);if(e){const r=e.refs===vt?e.refs={}:e.refs;Object.defineProperty(r,t,{enumerable:!0,get:()=>n.value,set:s=>n.value=s})}return n}const ya=new WeakMap;function ks(t,e,n,i,r=!1){if(Xe(t)){t.forEach((_,v)=>ks(_,e&&(Xe(e)?e[v]:e),n,i,r));return}if(is(i)&&!r){i.shapeFlag&512&&i.type.__asyncResolved&&i.component.subTree.component&&ks(t,e,n,i.component.subTree);return}const s=i.shapeFlag&4?Wa(i.component):i.el,o=r?null:s,{i:a,r:l}=t,c=e&&e.r,u=a.refs===vt?a.refs={}:a.refs,f=a.setupState,h=st(f),p=f===vt?Fp:_=>dt(h,_);if(c!=null&&c!==l){if($f(e),Ot(c))u[c]=null,p(c)&&(f[c]=null);else if(Lt(c)){c.value=null;const _=e;_.k&&(u[_.k]=null)}}if(qe(l))po(l,a,12,[o,u]);else{const _=Ot(l),v=Lt(l);if(_||v){const m=()=>{if(t.f){const d=_?p(l)?f[l]:u[l]:l.value;if(r)Xe(d)&&Iu(d,s);else if(Xe(d))d.includes(s)||d.push(s);else if(_)u[l]=[s],p(l)&&(f[l]=u[l]);else{const S=[s];l.value=S,t.k&&(u[t.k]=S)}}else _?(u[l]=o,p(l)&&(f[l]=o)):v&&(l.value=o,t.k&&(u[t.k]=o))};if(o){const d=()=>{m(),ya.delete(t)};d.id=-1,ya.set(t,d),En(d,n)}else $f(t),m()}}}function $f(t){const e=ya.get(t);e&&(e.flags|=8,ya.delete(t))}Oa().requestIdleCallback;Oa().cancelIdleCallback;const is=t=>!!t.type.__asyncLoader,vm=t=>t.type.__isKeepAlive;function D0(t,e){xm(t,"a",e)}function U0(t,e){xm(t,"da",e)}function xm(t,e,n=Qt){const i=t.__wdc||(t.__wdc=()=>{let r=n;for(;r;){if(r.isDeactivated)return;r=r.parent}return t()});if(Ha(e,i,n),n){let r=n.parent;for(;r&&r.parent;)vm(r.parent.vnode)&&N0(i,e,n,r),r=r.parent}}function N0(t,e,n,i){const r=Ha(e,t,i,!0);za(()=>{Iu(i[e],r)},n)}function Ha(t,e,n=Qt,i=!1){if(n){const r=n[t]||(n[t]=[]),s=e.__weh||(e.__weh=(...o)=>{Ci();const a=go(n),l=oi(e,n,t,o);return a(),Pi(),l});return i?r.unshift(s):r.push(s),s}}const Di=t=>(e,n=Qt)=>{(!Zs||t==="sp")&&Ha(t,(...i)=>e(...i),n)},Sm=Di("bm"),qu=Di("m"),O0=Di("bu"),F0=Di("u"),B0=Di("bum"),za=Di("um"),k0=Di("sp"),H0=Di("rtg"),z0=Di("rtc");function V0(t,e=Qt){Ha("ec",t,e)}const G0="components";function Ai(t,e){return X0(G0,t,!0,e)||t}const W0=Symbol.for("v-ndc");function X0(t,e,n=!0,i=!1){const r=$t||Qt;if(r){const s=r.type;{const a=Dv(s,!1);if(a&&(a===e||a===Dn(e)||a===Na(Dn(e))))return s}const o=qf(r[t]||s[t],e)||qf(r.appContext[t],e);return!o&&i?s:o}}function qf(t,e){return t&&(t[e]||t[Dn(e)]||t[Na(Dn(e))])}function gc(t,e,n,i){let r;const s=n,o=Xe(t);if(o||Ot(t)){const a=o&&ji(t);let l=!1,c=!1;a&&(l=!In(t),c=Zi(t),t=Ba(t)),r=new Array(t.length);for(let u=0,f=t.length;u<f;u++)r[u]=e(l?c?_a(Xt(t[u])):Xt(t[u]):t[u],u,void 0,s)}else if(typeof t=="number"){r=new Array(t);for(let a=0;a<t;a++)r[a]=e(a+1,a,void 0,s)}else if(Tt(t))if(t[Symbol.iterator])r=Array.from(t,(a,l)=>e(a,l,void 0,s));else{const a=Object.keys(t);r=new Array(a.length);for(let l=0,c=a.length;l<c;l++){const u=a[l];r[l]=e(t[u],u,l,s)}}else r=[];return r}function Ea(t,e,n={},i,r){if($t.ce||$t.parent&&is($t.parent)&&$t.parent.ce)return e!=="default"&&(n.name=e),Je(),Ys(Ut,null,[ct("slot",n,i&&i())],64);let s=t[e];s&&s._c&&(s._d=!1),Je();const o=s&&ym(s(n)),a=n.key||o&&o.key,l=Ys(Ut,{key:(a&&!Ii(a)?a:`_${e}`)+(!o&&i?"_fb":"")},o||(i?i():[]),o&&t._===1?64:-2);return s&&s._c&&(s._d=!0),l}function ym(t){return t.some(e=>Ks(e)?!(e.type===Li||e.type===Ut&&!ym(e.children)):!0)?t:null}const _c=t=>t?Hm(t)?Wa(t):_c(t.parent):null,Hs=tn(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>_c(t.parent),$root:t=>_c(t.root),$host:t=>t.ce,$emit:t=>t.emit,$options:t=>Mm(t),$forceUpdate:t=>t.f||(t.f=()=>{Xu(t.update)}),$nextTick:t=>t.n||(t.n=Wu.bind(t.proxy)),$watch:t=>dv.bind(t)}),ml=(t,e)=>t!==vt&&!t.__isScriptSetup&&dt(t,e),$0={get({_:t},e){if(e==="__v_skip")return!0;const{ctx:n,setupState:i,data:r,props:s,accessCache:o,type:a,appContext:l}=t;let c;if(e[0]!=="$"){const p=o[e];if(p!==void 0)switch(p){case 1:return i[e];case 2:return r[e];case 4:return n[e];case 3:return s[e]}else{if(ml(i,e))return o[e]=1,i[e];if(r!==vt&&dt(r,e))return o[e]=2,r[e];if((c=t.propsOptions[0])&&dt(c,e))return o[e]=3,s[e];if(n!==vt&&dt(n,e))return o[e]=4,n[e];vc&&(o[e]=0)}}const u=Hs[e];let f,h;if(u)return e==="$attrs"&&Jt(t.attrs,"get",""),u(t);if((f=a.__cssModules)&&(f=f[e]))return f;if(n!==vt&&dt(n,e))return o[e]=4,n[e];if(h=l.config.globalProperties,dt(h,e))return h[e]},set({_:t},e,n){const{data:i,setupState:r,ctx:s}=t;return ml(r,e)?(r[e]=n,!0):i!==vt&&dt(i,e)?(i[e]=n,!0):dt(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(s[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:i,appContext:r,propsOptions:s,type:o}},a){let l,c;return!!(n[a]||t!==vt&&a[0]!=="$"&&dt(t,a)||ml(e,a)||(l=s[0])&&dt(l,a)||dt(i,a)||dt(Hs,a)||dt(r.config.globalProperties,a)||(c=o.__cssModules)&&c[a])},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:dt(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};function jf(t){return Xe(t)?t.reduce((e,n)=>(e[n]=null,e),{}):t}let vc=!0;function q0(t){const e=Mm(t),n=t.proxy,i=t.ctx;vc=!1,e.beforeCreate&&Yf(e.beforeCreate,t,"bc");const{data:r,computed:s,methods:o,watch:a,provide:l,inject:c,created:u,beforeMount:f,mounted:h,beforeUpdate:p,updated:_,activated:v,deactivated:m,beforeDestroy:d,beforeUnmount:S,destroyed:E,unmounted:x,render:P,renderTracked:I,renderTriggered:R,errorCaptured:O,serverPrefetch:A,expose:T,inheritAttrs:F,components:Y,directives:q,filters:oe}=e;if(c&&j0(c,i,null),o)for(const J in o){const W=o[J];qe(W)&&(i[J]=W.bind(n))}if(r){const J=r.call(n,n);Tt(J)&&(t.data=ho(J))}if(vc=!0,s)for(const J in s){const W=s[J],me=qe(W)?W.bind(n,n):qe(W.get)?W.get.bind(n,n):ni,Se=!qe(W)&&qe(W.set)?W.set.bind(n):ni,Re=Bt({get:me,set:Se});Object.defineProperty(i,J,{enumerable:!0,configurable:!0,get:()=>Re.value,set:Be=>Re.value=Be})}if(a)for(const J in a)Em(a[J],i,n,J);if(l){const J=qe(l)?l.call(n):l;Reflect.ownKeys(J).forEach(W=>{ia(W,J[W])})}u&&Yf(u,t,"c");function te(J,W){Xe(W)?W.forEach(me=>J(me.bind(n))):W&&J(W.bind(n))}if(te(Sm,f),te(qu,h),te(O0,p),te(F0,_),te(D0,v),te(U0,m),te(V0,O),te(z0,I),te(H0,R),te(B0,S),te(za,x),te(k0,A),Xe(T))if(T.length){const J=t.exposed||(t.exposed={});T.forEach(W=>{Object.defineProperty(J,W,{get:()=>n[W],set:me=>n[W]=me,enumerable:!0})})}else t.exposed||(t.exposed={});P&&t.render===ni&&(t.render=P),F!=null&&(t.inheritAttrs=F),Y&&(t.components=Y),q&&(t.directives=q),A&&_m(t)}function j0(t,e,n=ni){Xe(t)&&(t=xc(t));for(const i in t){const r=t[i];let s;Tt(r)?"default"in r?s=Gn(r.from||i,r.default,!0):s=Gn(r.from||i):s=Gn(r),Lt(s)?Object.defineProperty(e,i,{enumerable:!0,configurable:!0,get:()=>s.value,set:o=>s.value=o}):e[i]=s}}function Yf(t,e,n){oi(Xe(t)?t.map(i=>i.bind(e.proxy)):t.bind(e.proxy),e,n)}function Em(t,e,n,i){let r=i.includes(".")?Nm(n,i):()=>n[i];if(Ot(t)){const s=e[t];qe(s)&&wi(r,s)}else if(qe(t))wi(r,t.bind(n));else if(Tt(t))if(Xe(t))t.forEach(s=>Em(s,e,n,i));else{const s=qe(t.handler)?t.handler.bind(n):e[t.handler];qe(s)&&wi(r,s,t)}}function Mm(t){const e=t.type,{mixins:n,extends:i}=e,{mixins:r,optionsCache:s,config:{optionMergeStrategies:o}}=t.appContext,a=s.get(e);let l;return a?l=a:!r.length&&!n&&!i?l=e:(l={},r.length&&r.forEach(c=>Ma(l,c,o,!0)),Ma(l,e,o)),Tt(e)&&s.set(e,l),l}function Ma(t,e,n,i=!1){const{mixins:r,extends:s}=e;s&&Ma(t,s,n,!0),r&&r.forEach(o=>Ma(t,o,n,!0));for(const o in e)if(!(i&&o==="expose")){const a=Y0[o]||n&&n[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const Y0={data:Kf,props:Zf,emits:Zf,methods:Us,computed:Us,beforeCreate:rn,created:rn,beforeMount:rn,mounted:rn,beforeUpdate:rn,updated:rn,beforeDestroy:rn,beforeUnmount:rn,destroyed:rn,unmounted:rn,activated:rn,deactivated:rn,errorCaptured:rn,serverPrefetch:rn,components:Us,directives:Us,watch:Z0,provide:Kf,inject:K0};function Kf(t,e){return e?t?function(){return tn(qe(t)?t.call(this,this):t,qe(e)?e.call(this,this):e)}:e:t}function K0(t,e){return Us(xc(t),xc(e))}function xc(t){if(Xe(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function rn(t,e){return t?[...new Set([].concat(t,e))]:e}function Us(t,e){return t?tn(Object.create(null),t,e):e}function Zf(t,e){return t?Xe(t)&&Xe(e)?[...new Set([...t,...e])]:tn(Object.create(null),jf(t),jf(e??{})):e}function Z0(t,e){if(!t)return e;if(!e)return t;const n=tn(Object.create(null),t);for(const i in e)n[i]=rn(t[i],e[i]);return n}function bm(){return{app:null,config:{isNativeTag:Fp,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let J0=0;function Q0(t,e){return function(i,r=null){qe(i)||(i=tn({},i)),r!=null&&!Tt(r)&&(r=null);const s=bm(),o=new WeakSet,a=[];let l=!1;const c=s.app={_uid:J0++,_component:i,_props:r,_container:null,_context:s,_instance:null,version:Nv,get config(){return s.config},set config(u){},use(u,...f){return o.has(u)||(u&&qe(u.install)?(o.add(u),u.install(c,...f)):qe(u)&&(o.add(u),u(c,...f))),c},mixin(u){return s.mixins.includes(u)||s.mixins.push(u),c},component(u,f){return f?(s.components[u]=f,c):s.components[u]},directive(u,f){return f?(s.directives[u]=f,c):s.directives[u]},mount(u,f,h){if(!l){const p=c._ceVNode||ct(i,r);return p.appContext=s,h===!0?h="svg":h===!1&&(h=void 0),t(p,u,h),l=!0,c._container=u,u.__vue_app__=c,Wa(p.component)}},onUnmount(u){a.push(u)},unmount(){l&&(oi(a,c._instance,16),t(null,c._container),delete c._container.__vue_app__)},provide(u,f){return s.provides[u]=f,c},runWithContext(u){const f=Tr;Tr=c;try{return u()}finally{Tr=f}}};return c}}let Tr=null;function ia(t,e){if(Qt){let n=Qt.provides;const i=Qt.parent&&Qt.parent.provides;i===n&&(n=Qt.provides=Object.create(i)),n[t]=e}}function Gn(t,e,n=!1){const i=Ji();if(i||Tr){let r=Tr?Tr._context.provides:i?i.parent==null||i.ce?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides:void 0;if(r&&t in r)return r[t];if(arguments.length>1)return n&&qe(e)?e.call(i&&i.proxy):e}}function ev(){return!!(Ji()||Tr)}const Tm={},Am=()=>Object.create(Tm),wm=t=>Object.getPrototypeOf(t)===Tm;function tv(t,e,n,i=!1){const r={},s=Am();t.propsDefaults=Object.create(null),Rm(t,e,r,s);for(const o in t.propsOptions[0])o in r||(r[o]=void 0);n?t.props=i?r:lm(r):t.type.props?t.props=r:t.props=s,t.attrs=s}function nv(t,e,n,i){const{props:r,attrs:s,vnode:{patchFlag:o}}=t,a=st(r),[l]=t.propsOptions;let c=!1;if((i||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let f=0;f<u.length;f++){let h=u[f];if(Ga(t.emitsOptions,h))continue;const p=e[h];if(l)if(dt(s,h))p!==s[h]&&(s[h]=p,c=!0);else{const _=Dn(h);r[_]=Sc(l,a,_,p,t,!1)}else p!==s[h]&&(s[h]=p,c=!0)}}}else{Rm(t,e,r,s)&&(c=!0);let u;for(const f in a)(!e||!dt(e,f)&&((u=Pr(f))===f||!dt(e,u)))&&(l?n&&(n[f]!==void 0||n[u]!==void 0)&&(r[f]=Sc(l,a,f,void 0,t,!0)):delete r[f]);if(s!==a)for(const f in s)(!e||!dt(e,f))&&(delete s[f],c=!0)}c&&xi(t.attrs,"set","")}function Rm(t,e,n,i){const[r,s]=t.propsOptions;let o=!1,a;if(e)for(let l in e){if(Os(l))continue;const c=e[l];let u;r&&dt(r,u=Dn(l))?!s||!s.includes(u)?n[u]=c:(a||(a={}))[u]=c:Ga(t.emitsOptions,l)||(!(l in i)||c!==i[l])&&(i[l]=c,o=!0)}if(s){const l=st(n),c=a||vt;for(let u=0;u<s.length;u++){const f=s[u];n[f]=Sc(r,l,f,c[f],t,!dt(c,f))}}return o}function Sc(t,e,n,i,r,s){const o=t[n];if(o!=null){const a=dt(o,"default");if(a&&i===void 0){const l=o.default;if(o.type!==Function&&!o.skipFactory&&qe(l)){const{propsDefaults:c}=r;if(n in c)i=c[n];else{const u=go(r);i=c[n]=l.call(null,e),u()}}else i=l;r.ce&&r.ce._setProp(n,i)}o[0]&&(s&&!a?i=!1:o[1]&&(i===""||i===Pr(n))&&(i=!0))}return i}const iv=new WeakMap;function Cm(t,e,n=!1){const i=n?iv:e.propsCache,r=i.get(t);if(r)return r;const s=t.props,o={},a=[];let l=!1;if(!qe(t)){const u=f=>{l=!0;const[h,p]=Cm(f,e,!0);tn(o,h),p&&a.push(...p)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!s&&!l)return Tt(t)&&i.set(t,es),es;if(Xe(s))for(let u=0;u<s.length;u++){const f=Dn(s[u]);Jf(f)&&(o[f]=vt)}else if(s)for(const u in s){const f=Dn(u);if(Jf(f)){const h=s[u],p=o[f]=Xe(h)||qe(h)?{type:h}:tn({},h),_=p.type;let v=!1,m=!0;if(Xe(_))for(let d=0;d<_.length;++d){const S=_[d],E=qe(S)&&S.name;if(E==="Boolean"){v=!0;break}else E==="String"&&(m=!1)}else v=qe(_)&&_.name==="Boolean";p[0]=v,p[1]=m,(v||dt(p,"default"))&&a.push(f)}}const c=[o,a];return Tt(t)&&i.set(t,c),c}function Jf(t){return t[0]!=="$"&&!Os(t)}const ju=t=>t==="_"||t==="_ctx"||t==="$stable",Yu=t=>Xe(t)?t.map(Jn):[Jn(t)],rv=(t,e,n)=>{if(e._n)return e;const i=Ft((...r)=>Yu(e(...r)),n);return i._c=!1,i},Pm=(t,e,n)=>{const i=t._ctx;for(const r in t){if(ju(r))continue;const s=t[r];if(qe(s))e[r]=rv(r,s,i);else if(s!=null){const o=Yu(s);e[r]=()=>o}}},Lm=(t,e)=>{const n=Yu(e);t.slots.default=()=>n},Im=(t,e,n)=>{for(const i in e)(n||!ju(i))&&(t[i]=e[i])},sv=(t,e,n)=>{const i=t.slots=Am();if(t.vnode.shapeFlag&32){const r=e._;r?(Im(i,e,n),n&&Vp(i,"_",r,!0)):Pm(e,i)}else e&&Lm(t,e)},ov=(t,e,n)=>{const{vnode:i,slots:r}=t;let s=!0,o=vt;if(i.shapeFlag&32){const a=e._;a?n&&a===1?s=!1:Im(r,e,n):(s=!e.$stable,Pm(e,r)),o=e}else e&&(Lm(t,e),o={default:1});if(s)for(const a in r)!ju(a)&&o[a]==null&&delete r[a]},En=yv;function av(t){return lv(t)}function lv(t,e){const n=Oa();n.__VUE__=!0;const{insert:i,remove:r,patchProp:s,createElement:o,createText:a,createComment:l,setText:c,setElementText:u,parentNode:f,nextSibling:h,setScopeId:p=ni,insertStaticContent:_}=t,v=(D,U,y,ie=null,Z=null,K=null,b=void 0,C=null,N=!!U.dynamicChildren)=>{if(D===U)return;D&&!Ts(D,U)&&(ie=H(D),Be(D,Z,K,!0),D=null),U.patchFlag===-2&&(N=!1,U.dynamicChildren=null);const{type:k,ref:pe,shapeFlag:M}=U;switch(k){case mo:m(D,U,y,ie);break;case Li:d(D,U,y,ie);break;case _l:D==null&&S(U,y,ie,b);break;case Ut:Y(D,U,y,ie,Z,K,b,C,N);break;default:M&1?P(D,U,y,ie,Z,K,b,C,N):M&6?q(D,U,y,ie,Z,K,b,C,N):(M&64||M&128)&&k.process(D,U,y,ie,Z,K,b,C,N,le)}pe!=null&&Z?ks(pe,D&&D.ref,K,U||D,!U):pe==null&&D&&D.ref!=null&&ks(D.ref,null,K,D,!0)},m=(D,U,y,ie)=>{if(D==null)i(U.el=a(U.children),y,ie);else{const Z=U.el=D.el;U.children!==D.children&&c(Z,U.children)}},d=(D,U,y,ie)=>{D==null?i(U.el=l(U.children||""),y,ie):U.el=D.el},S=(D,U,y,ie)=>{[D.el,D.anchor]=_(D.children,U,y,ie,D.el,D.anchor)},E=({el:D,anchor:U},y,ie)=>{let Z;for(;D&&D!==U;)Z=h(D),i(D,y,ie),D=Z;i(U,y,ie)},x=({el:D,anchor:U})=>{let y;for(;D&&D!==U;)y=h(D),r(D),D=y;r(U)},P=(D,U,y,ie,Z,K,b,C,N)=>{U.type==="svg"?b="svg":U.type==="math"&&(b="mathml"),D==null?I(U,y,ie,Z,K,b,C,N):A(D,U,Z,K,b,C,N)},I=(D,U,y,ie,Z,K,b,C)=>{let N,k;const{props:pe,shapeFlag:M,transition:g,dirs:L}=D;if(N=D.el=o(D.type,K,pe&&pe.is,pe),M&8?u(N,D.children):M&16&&O(D.children,N,null,ie,Z,gl(D,K),b,C),L&&ar(D,null,ie,"created"),R(N,D,D.scopeId,b,ie),pe){for(const j in pe)j!=="value"&&!Os(j)&&s(N,j,null,pe[j],K,ie);"value"in pe&&s(N,"value",null,pe.value,K),(k=pe.onVnodeBeforeMount)&&jn(k,ie,D)}L&&ar(D,null,ie,"beforeMount");const z=cv(Z,g);z&&g.beforeEnter(N),i(N,U,y),((k=pe&&pe.onVnodeMounted)||z||L)&&En(()=>{k&&jn(k,ie,D),z&&g.enter(N),L&&ar(D,null,ie,"mounted")},Z)},R=(D,U,y,ie,Z)=>{if(y&&p(D,y),ie)for(let K=0;K<ie.length;K++)p(D,ie[K]);if(Z){let K=Z.subTree;if(U===K||Fm(K.type)&&(K.ssContent===U||K.ssFallback===U)){const b=Z.vnode;R(D,b,b.scopeId,b.slotScopeIds,Z.parent)}}},O=(D,U,y,ie,Z,K,b,C,N=0)=>{for(let k=N;k<D.length;k++){const pe=D[k]=C?Wi(D[k]):Jn(D[k]);v(null,pe,U,y,ie,Z,K,b,C)}},A=(D,U,y,ie,Z,K,b)=>{const C=U.el=D.el;let{patchFlag:N,dynamicChildren:k,dirs:pe}=U;N|=D.patchFlag&16;const M=D.props||vt,g=U.props||vt;let L;if(y&&lr(y,!1),(L=g.onVnodeBeforeUpdate)&&jn(L,y,U,D),pe&&ar(U,D,y,"beforeUpdate"),y&&lr(y,!0),(M.innerHTML&&g.innerHTML==null||M.textContent&&g.textContent==null)&&u(C,""),k?T(D.dynamicChildren,k,C,y,ie,gl(U,Z),K):b||W(D,U,C,null,y,ie,gl(U,Z),K,!1),N>0){if(N&16)F(C,M,g,y,Z);else if(N&2&&M.class!==g.class&&s(C,"class",null,g.class,Z),N&4&&s(C,"style",M.style,g.style,Z),N&8){const z=U.dynamicProps;for(let j=0;j<z.length;j++){const X=z[j],Ee=M[X],he=g[X];(he!==Ee||X==="value")&&s(C,X,Ee,he,Z,y)}}N&1&&D.children!==U.children&&u(C,U.children)}else!b&&k==null&&F(C,M,g,y,Z);((L=g.onVnodeUpdated)||pe)&&En(()=>{L&&jn(L,y,U,D),pe&&ar(U,D,y,"updated")},ie)},T=(D,U,y,ie,Z,K,b)=>{for(let C=0;C<U.length;C++){const N=D[C],k=U[C],pe=N.el&&(N.type===Ut||!Ts(N,k)||N.shapeFlag&198)?f(N.el):y;v(N,k,pe,null,ie,Z,K,b,!0)}},F=(D,U,y,ie,Z)=>{if(U!==y){if(U!==vt)for(const K in U)!Os(K)&&!(K in y)&&s(D,K,U[K],null,Z,ie);for(const K in y){if(Os(K))continue;const b=y[K],C=U[K];b!==C&&K!=="value"&&s(D,K,C,b,Z,ie)}"value"in y&&s(D,"value",U.value,y.value,Z)}},Y=(D,U,y,ie,Z,K,b,C,N)=>{const k=U.el=D?D.el:a(""),pe=U.anchor=D?D.anchor:a("");let{patchFlag:M,dynamicChildren:g,slotScopeIds:L}=U;L&&(C=C?C.concat(L):L),D==null?(i(k,y,ie),i(pe,y,ie),O(U.children||[],y,pe,Z,K,b,C,N)):M>0&&M&64&&g&&D.dynamicChildren?(T(D.dynamicChildren,g,y,Z,K,b,C),(U.key!=null||Z&&U===Z.subTree)&&Dm(D,U,!0)):W(D,U,y,pe,Z,K,b,C,N)},q=(D,U,y,ie,Z,K,b,C,N)=>{U.slotScopeIds=C,D==null?U.shapeFlag&512?Z.ctx.activate(U,y,ie,b,N):oe(U,y,ie,Z,K,b,N):ae(D,U,N)},oe=(D,U,y,ie,Z,K,b)=>{const C=D.component=Rv(D,ie,Z);if(vm(D)&&(C.ctx.renderer=le),Cv(C,!1,b),C.asyncDep){if(Z&&Z.registerDep(C,te,b),!D.el){const N=C.subTree=ct(Li);d(null,N,U,y),D.placeholder=N.el}}else te(C,D,U,y,Z,K,b)},ae=(D,U,y)=>{const ie=U.component=D.component;if(xv(D,U,y))if(ie.asyncDep&&!ie.asyncResolved){J(ie,U,y);return}else ie.next=U,ie.update();else U.el=D.el,ie.vnode=U},te=(D,U,y,ie,Z,K,b)=>{const C=()=>{if(D.isMounted){let{next:M,bu:g,u:L,parent:z,vnode:j}=D;{const Ce=Um(D);if(Ce){M&&(M.el=j.el,J(D,M,b)),Ce.asyncDep.then(()=>{D.isUnmounted||C()});return}}let X=M,Ee;lr(D,!1),M?(M.el=j.el,J(D,M,b)):M=j,g&&na(g),(Ee=M.props&&M.props.onVnodeBeforeUpdate)&&jn(Ee,z,M,j),lr(D,!0);const he=eh(D),Te=D.subTree;D.subTree=he,v(Te,he,f(Te.el),H(Te),D,Z,K),M.el=he.el,X===null&&Sv(D,he.el),L&&En(L,Z),(Ee=M.props&&M.props.onVnodeUpdated)&&En(()=>jn(Ee,z,M,j),Z)}else{let M;const{el:g,props:L}=U,{bm:z,m:j,parent:X,root:Ee,type:he}=D,Te=is(U);lr(D,!1),z&&na(z),!Te&&(M=L&&L.onVnodeBeforeMount)&&jn(M,X,U),lr(D,!0);{Ee.ce&&Ee.ce._def.shadowRoot!==!1&&Ee.ce._injectChildStyle(he);const Ce=D.subTree=eh(D);v(null,Ce,y,ie,D,Z,K),U.el=Ce.el}if(j&&En(j,Z),!Te&&(M=L&&L.onVnodeMounted)){const Ce=U;En(()=>jn(M,X,Ce),Z)}(U.shapeFlag&256||X&&is(X.vnode)&&X.vnode.shapeFlag&256)&&D.a&&En(D.a,Z),D.isMounted=!0,U=y=ie=null}};D.scope.on();const N=D.effect=new jp(C);D.scope.off();const k=D.update=N.run.bind(N),pe=D.job=N.runIfDirty.bind(N);pe.i=D,pe.id=D.uid,N.scheduler=()=>Xu(pe),lr(D,!0),k()},J=(D,U,y)=>{U.component=D;const ie=D.vnode.props;D.vnode=U,D.next=null,nv(D,U.props,ie,y),ov(D,U.children,y),Ci(),Gf(D),Pi()},W=(D,U,y,ie,Z,K,b,C,N=!1)=>{const k=D&&D.children,pe=D?D.shapeFlag:0,M=U.children,{patchFlag:g,shapeFlag:L}=U;if(g>0){if(g&128){Se(k,M,y,ie,Z,K,b,C,N);return}else if(g&256){me(k,M,y,ie,Z,K,b,C,N);return}}L&8?(pe&16&&be(k,Z,K),M!==k&&u(y,M)):pe&16?L&16?Se(k,M,y,ie,Z,K,b,C,N):be(k,Z,K,!0):(pe&8&&u(y,""),L&16&&O(M,y,ie,Z,K,b,C,N))},me=(D,U,y,ie,Z,K,b,C,N)=>{D=D||es,U=U||es;const k=D.length,pe=U.length,M=Math.min(k,pe);let g;for(g=0;g<M;g++){const L=U[g]=N?Wi(U[g]):Jn(U[g]);v(D[g],L,y,null,Z,K,b,C,N)}k>pe?be(D,Z,K,!0,!1,M):O(U,y,ie,Z,K,b,C,N,M)},Se=(D,U,y,ie,Z,K,b,C,N)=>{let k=0;const pe=U.length;let M=D.length-1,g=pe-1;for(;k<=M&&k<=g;){const L=D[k],z=U[k]=N?Wi(U[k]):Jn(U[k]);if(Ts(L,z))v(L,z,y,null,Z,K,b,C,N);else break;k++}for(;k<=M&&k<=g;){const L=D[M],z=U[g]=N?Wi(U[g]):Jn(U[g]);if(Ts(L,z))v(L,z,y,null,Z,K,b,C,N);else break;M--,g--}if(k>M){if(k<=g){const L=g+1,z=L<pe?U[L].el:ie;for(;k<=g;)v(null,U[k]=N?Wi(U[k]):Jn(U[k]),y,z,Z,K,b,C,N),k++}}else if(k>g)for(;k<=M;)Be(D[k],Z,K,!0),k++;else{const L=k,z=k,j=new Map;for(k=z;k<=g;k++){const Ue=U[k]=N?Wi(U[k]):Jn(U[k]);Ue.key!=null&&j.set(Ue.key,k)}let X,Ee=0;const he=g-z+1;let Te=!1,Ce=0;const fe=new Array(he);for(k=0;k<he;k++)fe[k]=0;for(k=L;k<=M;k++){const Ue=D[k];if(Ee>=he){Be(Ue,Z,K,!0);continue}let Ne;if(Ue.key!=null)Ne=j.get(Ue.key);else for(X=z;X<=g;X++)if(fe[X-z]===0&&Ts(Ue,U[X])){Ne=X;break}Ne===void 0?Be(Ue,Z,K,!0):(fe[Ne-z]=k+1,Ne>=Ce?Ce=Ne:Te=!0,v(Ue,U[Ne],y,null,Z,K,b,C,N),Ee++)}const Pe=Te?uv(fe):es;for(X=Pe.length-1,k=he-1;k>=0;k--){const Ue=z+k,Ne=U[Ue],ye=U[Ue+1],Ve=Ue+1<pe?ye.el||ye.placeholder:ie;fe[k]===0?v(null,Ne,y,Ve,Z,K,b,C,N):Te&&(X<0||k!==Pe[X]?Re(Ne,y,Ve,2):X--)}}},Re=(D,U,y,ie,Z=null)=>{const{el:K,type:b,transition:C,children:N,shapeFlag:k}=D;if(k&6){Re(D.component.subTree,U,y,ie);return}if(k&128){D.suspense.move(U,y,ie);return}if(k&64){b.move(D,U,y,le);return}if(b===Ut){i(K,U,y);for(let M=0;M<N.length;M++)Re(N[M],U,y,ie);i(D.anchor,U,y);return}if(b===_l){E(D,U,y);return}if(ie!==2&&k&1&&C)if(ie===0)C.beforeEnter(K),i(K,U,y),En(()=>C.enter(K),Z);else{const{leave:M,delayLeave:g,afterLeave:L}=C,z=()=>{D.ctx.isUnmounted?r(K):i(K,U,y)},j=()=>{K._isLeaving&&K[I0](!0),M(K,()=>{z(),L&&L()})};g?g(K,z,j):j()}else i(K,U,y)},Be=(D,U,y,ie=!1,Z=!1)=>{const{type:K,props:b,ref:C,children:N,dynamicChildren:k,shapeFlag:pe,patchFlag:M,dirs:g,cacheIndex:L}=D;if(M===-2&&(Z=!1),C!=null&&(Ci(),ks(C,null,y,D,!0),Pi()),L!=null&&(U.renderCache[L]=void 0),pe&256){U.ctx.deactivate(D);return}const z=pe&1&&g,j=!is(D);let X;if(j&&(X=b&&b.onVnodeBeforeUnmount)&&jn(X,U,D),pe&6)xe(D.component,y,ie);else{if(pe&128){D.suspense.unmount(y,ie);return}z&&ar(D,null,U,"beforeUnmount"),pe&64?D.type.remove(D,U,y,le,ie):k&&!k.hasOnce&&(K!==Ut||M>0&&M&64)?be(k,U,y,!1,!0):(K===Ut&&M&384||!Z&&pe&16)&&be(N,U,y),ie&&Ze(D)}(j&&(X=b&&b.onVnodeUnmounted)||z)&&En(()=>{X&&jn(X,U,D),z&&ar(D,null,U,"unmounted")},y)},Ze=D=>{const{type:U,el:y,anchor:ie,transition:Z}=D;if(U===Ut){se(y,ie);return}if(U===_l){x(D);return}const K=()=>{r(y),Z&&!Z.persisted&&Z.afterLeave&&Z.afterLeave()};if(D.shapeFlag&1&&Z&&!Z.persisted){const{leave:b,delayLeave:C}=Z,N=()=>b(y,K);C?C(D.el,K,N):N()}else K()},se=(D,U)=>{let y;for(;D!==U;)y=h(D),r(D),D=y;r(U)},xe=(D,U,y)=>{const{bum:ie,scope:Z,job:K,subTree:b,um:C,m:N,a:k}=D;Qf(N),Qf(k),ie&&na(ie),Z.stop(),K&&(K.flags|=8,Be(b,D,U,y)),C&&En(C,U),En(()=>{D.isUnmounted=!0},U)},be=(D,U,y,ie=!1,Z=!1,K=0)=>{for(let b=K;b<D.length;b++)Be(D[b],U,y,ie,Z)},H=D=>{if(D.shapeFlag&6)return H(D.component.subTree);if(D.shapeFlag&128)return D.suspense.next();const U=h(D.anchor||D.el),y=U&&U[P0];return y?h(y):U};let re=!1;const ce=(D,U,y)=>{D==null?U._vnode&&Be(U._vnode,null,null,!0):v(U._vnode||null,D,U,null,null,null,y),U._vnode=D,re||(re=!0,Gf(),pm(),re=!1)},le={p:v,um:Be,m:Re,r:Ze,mt:oe,mc:O,pc:W,pbc:T,n:H,o:t};return{render:ce,hydrate:void 0,createApp:Q0(ce)}}function gl({type:t,props:e},n){return n==="svg"&&t==="foreignObject"||n==="mathml"&&t==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:n}function lr({effect:t,job:e},n){n?(t.flags|=32,e.flags|=4):(t.flags&=-33,e.flags&=-5)}function cv(t,e){return(!t||t&&!t.pendingBranch)&&e&&!e.persisted}function Dm(t,e,n=!1){const i=t.children,r=e.children;if(Xe(i)&&Xe(r))for(let s=0;s<i.length;s++){const o=i[s];let a=r[s];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=r[s]=Wi(r[s]),a.el=o.el),!n&&a.patchFlag!==-2&&Dm(o,a)),a.type===mo&&a.patchFlag!==-1&&(a.el=o.el),a.type===Li&&!a.el&&(a.el=o.el)}}function uv(t){const e=t.slice(),n=[0];let i,r,s,o,a;const l=t.length;for(i=0;i<l;i++){const c=t[i];if(c!==0){if(r=n[n.length-1],t[r]<c){e[i]=r,n.push(i);continue}for(s=0,o=n.length-1;s<o;)a=s+o>>1,t[n[a]]<c?s=a+1:o=a;c<t[n[s]]&&(s>0&&(e[i]=n[s-1]),n[s]=i)}}for(s=n.length,o=n[s-1];s-- >0;)n[s]=o,o=e[o];return n}function Um(t){const e=t.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:Um(e)}function Qf(t){if(t)for(let e=0;e<t.length;e++)t[e].flags|=8}const fv=Symbol.for("v-scx"),hv=()=>Gn(fv);function Va(t,e){return Ku(t,null,e)}function wi(t,e,n){return Ku(t,e,n)}function Ku(t,e,n=vt){const{immediate:i,deep:r,flush:s,once:o}=n,a=tn({},n),l=e&&i||!e&&s!=="post";let c;if(Zs){if(s==="sync"){const p=hv();c=p.__watcherHandles||(p.__watcherHandles=[])}else if(!l){const p=()=>{};return p.stop=ni,p.resume=ni,p.pause=ni,p}}const u=Qt;a.call=(p,_,v)=>oi(p,u,_,v);let f=!1;s==="post"?a.scheduler=p=>{En(p,u&&u.suspense)}:s!=="sync"&&(f=!0,a.scheduler=(p,_)=>{_?p():Xu(p)}),a.augmentJob=p=>{e&&(p.flags|=4),f&&(p.flags|=2,u&&(p.id=u.uid,p.i=u))};const h=A0(t,e,a);return Zs&&(c?c.push(h):l&&h()),h}function dv(t,e,n){const i=this.proxy,r=Ot(t)?t.includes(".")?Nm(i,t):()=>i[t]:t.bind(i,i);let s;qe(e)?s=e:(s=e.handler,n=e);const o=go(this),a=Ku(r,s.bind(i),n);return o(),a}function Nm(t,e){const n=e.split(".");return()=>{let i=t;for(let r=0;r<n.length&&i;r++)i=i[n[r]];return i}}const pv=(t,e)=>e==="modelValue"||e==="model-value"?t.modelModifiers:t[`${e}Modifiers`]||t[`${Dn(e)}Modifiers`]||t[`${Pr(e)}Modifiers`];function mv(t,e,...n){if(t.isUnmounted)return;const i=t.vnode.props||vt;let r=n;const s=e.startsWith("update:"),o=s&&pv(i,e.slice(7));o&&(o.trim&&(r=n.map(u=>Ot(u)?u.trim():u)),o.number&&(r=n.map(hc)));let a,l=i[a=ul(e)]||i[a=ul(Dn(e))];!l&&s&&(l=i[a=ul(Pr(e))]),l&&oi(l,t,6,r);const c=i[a+"Once"];if(c){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,oi(c,t,6,r)}}const gv=new WeakMap;function Om(t,e,n=!1){const i=n?gv:e.emitsCache,r=i.get(t);if(r!==void 0)return r;const s=t.emits;let o={},a=!1;if(!qe(t)){const l=c=>{const u=Om(c,e,!0);u&&(a=!0,tn(o,u))};!n&&e.mixins.length&&e.mixins.forEach(l),t.extends&&l(t.extends),t.mixins&&t.mixins.forEach(l)}return!s&&!a?(Tt(t)&&i.set(t,null),null):(Xe(s)?s.forEach(l=>o[l]=null):tn(o,s),Tt(t)&&i.set(t,o),o)}function Ga(t,e){return!t||!Ia(e)?!1:(e=e.slice(2).replace(/Once$/,""),dt(t,e[0].toLowerCase()+e.slice(1))||dt(t,Pr(e))||dt(t,e))}function eh(t){const{type:e,vnode:n,proxy:i,withProxy:r,propsOptions:[s],slots:o,attrs:a,emit:l,render:c,renderCache:u,props:f,data:h,setupState:p,ctx:_,inheritAttrs:v}=t,m=Sa(t);let d,S;try{if(n.shapeFlag&4){const x=r||i,P=x;d=Jn(c.call(P,x,u,f,p,h,_)),S=a}else{const x=e;d=Jn(x.length>1?x(f,{attrs:a,slots:o,emit:l}):x(f,null)),S=e.props?a:_v(a)}}catch(x){zs.length=0,ka(x,t,1),d=ct(Li)}let E=d;if(S&&v!==!1){const x=Object.keys(S),{shapeFlag:P}=E;x.length&&P&7&&(s&&x.some(Lu)&&(S=vv(S,s)),E=as(E,S,!1,!0))}return n.dirs&&(E=as(E,null,!1,!0),E.dirs=E.dirs?E.dirs.concat(n.dirs):n.dirs),n.transition&&$u(E,n.transition),d=E,Sa(m),d}const _v=t=>{let e;for(const n in t)(n==="class"||n==="style"||Ia(n))&&((e||(e={}))[n]=t[n]);return e},vv=(t,e)=>{const n={};for(const i in t)(!Lu(i)||!(i.slice(9)in e))&&(n[i]=t[i]);return n};function xv(t,e,n){const{props:i,children:r,component:s}=t,{props:o,children:a,patchFlag:l}=e,c=s.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&l>=0){if(l&1024)return!0;if(l&16)return i?th(i,o,c):!!o;if(l&8){const u=e.dynamicProps;for(let f=0;f<u.length;f++){const h=u[f];if(o[h]!==i[h]&&!Ga(c,h))return!0}}}else return(r||a)&&(!a||!a.$stable)?!0:i===o?!1:i?o?th(i,o,c):!0:!!o;return!1}function th(t,e,n){const i=Object.keys(e);if(i.length!==Object.keys(t).length)return!0;for(let r=0;r<i.length;r++){const s=i[r];if(e[s]!==t[s]&&!Ga(n,s))return!0}return!1}function Sv({vnode:t,parent:e},n){for(;e;){const i=e.subTree;if(i.suspense&&i.suspense.activeBranch===t&&(i.el=t.el),i===t)(t=e.vnode).el=n,e=e.parent;else break}}const Fm=t=>t.__isSuspense;function yv(t,e){e&&e.pendingBranch?Xe(t)?e.effects.push(...t):e.effects.push(t):C0(t)}const Ut=Symbol.for("v-fgt"),mo=Symbol.for("v-txt"),Li=Symbol.for("v-cmt"),_l=Symbol.for("v-stc"),zs=[];let Mn=null;function Je(t=!1){zs.push(Mn=t?null:[])}function Ev(){zs.pop(),Mn=zs[zs.length-1]||null}let js=1;function ba(t,e=!1){js+=t,t<0&&Mn&&e&&(Mn.hasOnce=!0)}function Bm(t){return t.dynamicChildren=js>0?Mn||es:null,Ev(),js>0&&Mn&&Mn.push(t),t}function at(t,e,n,i,r,s){return Bm(ve(t,e,n,i,r,s,!0))}function Ys(t,e,n,i,r){return Bm(ct(t,e,n,i,r,!0))}function Ks(t){return t?t.__v_isVNode===!0:!1}function Ts(t,e){return t.type===e.type&&t.key===e.key}const km=({key:t})=>t??null,ra=({ref:t,ref_key:e,ref_for:n})=>(typeof t=="number"&&(t=""+t),t!=null?Ot(t)||Lt(t)||qe(t)?{i:$t,r:t,k:e,f:!!n}:t:null);function ve(t,e=null,n=null,i=0,r=null,s=t===Ut?0:1,o=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&km(e),ref:e&&ra(e),scopeId:gm,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:s,patchFlag:i,dynamicProps:r,dynamicChildren:null,appContext:null,ctx:$t};return a?(Zu(l,n),s&128&&t.normalize(l)):n&&(l.shapeFlag|=Ot(n)?8:16),js>0&&!o&&Mn&&(l.patchFlag>0||s&6)&&l.patchFlag!==32&&Mn.push(l),l}const ct=Mv;function Mv(t,e=null,n=null,i=0,r=null,s=!1){if((!t||t===W0)&&(t=Li),Ks(t)){const a=as(t,e,!0);return n&&Zu(a,n),js>0&&!s&&Mn&&(a.shapeFlag&6?Mn[Mn.indexOf(t)]=a:Mn.push(a)),a.patchFlag=-2,a}if(Uv(t)&&(t=t.__vccOpts),e){e=bv(e);let{class:a,style:l}=e;a&&!Ot(a)&&(e.class=bn(a)),Tt(l)&&(zu(l)&&!Xe(l)&&(l=tn({},l)),e.style=Fa(l))}const o=Ot(t)?1:Fm(t)?128:L0(t)?64:Tt(t)?4:qe(t)?2:0;return ve(t,e,n,i,r,o,s,!0)}function bv(t){return t?zu(t)||wm(t)?tn({},t):t:null}function as(t,e,n=!1,i=!1){const{props:r,ref:s,patchFlag:o,children:a,transition:l}=t,c=e?Tv(r||{},e):r,u={__v_isVNode:!0,__v_skip:!0,type:t.type,props:c,key:c&&km(c),ref:e&&e.ref?n&&s?Xe(s)?s.concat(ra(e)):[s,ra(e)]:ra(e):s,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:a,target:t.target,targetStart:t.targetStart,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==Ut?o===-1?16:o|16:o,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:l,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&as(t.ssContent),ssFallback:t.ssFallback&&as(t.ssFallback),placeholder:t.placeholder,el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce};return l&&i&&$u(u,l.clone(u)),u}function Kt(t=" ",e=0){return ct(mo,null,t,e)}function ei(t="",e=!1){return e?(Je(),Ys(Li,null,t)):ct(Li,null,t)}function Jn(t){return t==null||typeof t=="boolean"?ct(Li):Xe(t)?ct(Ut,null,t.slice()):Ks(t)?Wi(t):ct(mo,null,String(t))}function Wi(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:as(t)}function Zu(t,e){let n=0;const{shapeFlag:i}=t;if(e==null)e=null;else if(Xe(e))n=16;else if(typeof e=="object")if(i&65){const r=e.default;r&&(r._c&&(r._d=!1),Zu(t,r()),r._c&&(r._d=!0));return}else{n=32;const r=e._;!r&&!wm(e)?e._ctx=$t:r===3&&$t&&($t.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else qe(e)?(e={default:e,_ctx:$t},n=32):(e=String(e),i&64?(n=16,e=[Kt(e)]):n=8);t.children=e,t.shapeFlag|=n}function Tv(...t){const e={};for(let n=0;n<t.length;n++){const i=t[n];for(const r in i)if(r==="class")e.class!==i.class&&(e.class=bn([e.class,i.class]));else if(r==="style")e.style=Fa([e.style,i.style]);else if(Ia(r)){const s=e[r],o=i[r];o&&s!==o&&!(Xe(s)&&s.includes(o))&&(e[r]=s?[].concat(s,o):o)}else r!==""&&(e[r]=i[r])}return e}function jn(t,e,n,i=null){oi(t,e,7,[n,i])}const Av=bm();let wv=0;function Rv(t,e,n){const i=t.type,r=(e?e.appContext:t.appContext)||Av,s={uid:wv++,vnode:t,type:i,parent:e,appContext:r,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new $p(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(r.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Cm(i,r),emitsOptions:Om(i,r),emit:null,emitted:null,propsDefaults:vt,inheritAttrs:i.inheritAttrs,ctx:vt,data:vt,props:vt,attrs:vt,slots:vt,refs:vt,setupState:vt,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return s.ctx={_:s},s.root=e?e.root:s,s.emit=mv.bind(null,s),t.ce&&t.ce(s),s}let Qt=null;const Ji=()=>Qt||$t;let Ta,yc;{const t=Oa(),e=(n,i)=>{let r;return(r=t[n])||(r=t[n]=[]),r.push(i),s=>{r.length>1?r.forEach(o=>o(s)):r[0](s)}};Ta=e("__VUE_INSTANCE_SETTERS__",n=>Qt=n),yc=e("__VUE_SSR_SETTERS__",n=>Zs=n)}const go=t=>{const e=Qt;return Ta(t),t.scope.on(),()=>{t.scope.off(),Ta(e)}},nh=()=>{Qt&&Qt.scope.off(),Ta(null)};function Hm(t){return t.vnode.shapeFlag&4}let Zs=!1;function Cv(t,e=!1,n=!1){e&&yc(e);const{props:i,children:r}=t.vnode,s=Hm(t);tv(t,i,s,e),sv(t,r,n||e);const o=s?Pv(t,e):void 0;return e&&yc(!1),o}function Pv(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=new Proxy(t.ctx,$0);const{setup:i}=n;if(i){Ci();const r=t.setupContext=i.length>1?Iv(t):null,s=go(t),o=po(i,t,0,[t.props,r]),a=kp(o);if(Pi(),s(),(a||t.sp)&&!is(t)&&_m(t),a){if(o.then(nh,nh),e)return o.then(l=>{ih(t,l)}).catch(l=>{ka(l,t,0)});t.asyncDep=o}else ih(t,o)}else zm(t)}function ih(t,e,n){qe(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:Tt(e)&&(t.setupState=fm(e)),zm(t)}function zm(t,e,n){const i=t.type;t.render||(t.render=i.render||ni);{const r=go(t);Ci();try{q0(t)}finally{Pi(),r()}}}const Lv={get(t,e){return Jt(t,"get",""),t[e]}};function Iv(t){const e=n=>{t.exposed=n||{}};return{attrs:new Proxy(t.attrs,Lv),slots:t.slots,emit:t.emit,expose:e}}function Wa(t){return t.exposed?t.exposeProxy||(t.exposeProxy=new Proxy(fm(Vu(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in Hs)return Hs[n](t)},has(e,n){return n in e||n in Hs}})):t.proxy}function Dv(t,e=!0){return qe(t)?t.displayName||t.name:t.name||e&&t.__name}function Uv(t){return qe(t)&&"__vccOpts"in t}const Bt=(t,e)=>b0(t,e,Zs);function Xa(t,e,n){const i=(s,o,a)=>{ba(-1);try{return ct(s,o,a)}finally{ba(1)}},r=arguments.length;return r===2?Tt(e)&&!Xe(e)?Ks(e)?i(t,null,[e]):i(t,e):i(t,null,e):(r>3?n=Array.prototype.slice.call(arguments,2):r===3&&Ks(n)&&(n=[n]),i(t,e,n))}const Nv="3.5.21";/**
* @vue/runtime-dom v3.5.21
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Ec;const rh=typeof window<"u"&&window.trustedTypes;if(rh)try{Ec=rh.createPolicy("vue",{createHTML:t=>t})}catch{}const Vm=Ec?t=>Ec.createHTML(t):t=>t,Ov="http://www.w3.org/2000/svg",Fv="http://www.w3.org/1998/Math/MathML",vi=typeof document<"u"?document:null,sh=vi&&vi.createElement("template"),Bv={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,i)=>{const r=e==="svg"?vi.createElementNS(Ov,t):e==="mathml"?vi.createElementNS(Fv,t):n?vi.createElement(t,{is:n}):vi.createElement(t);return t==="select"&&i&&i.multiple!=null&&r.setAttribute("multiple",i.multiple),r},createText:t=>vi.createTextNode(t),createComment:t=>vi.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>vi.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,n,i,r,s){const o=n?n.previousSibling:e.lastChild;if(r&&(r===s||r.nextSibling))for(;e.insertBefore(r.cloneNode(!0),n),!(r===s||!(r=r.nextSibling)););else{sh.innerHTML=Vm(i==="svg"?`<svg>${t}</svg>`:i==="mathml"?`<math>${t}</math>`:t);const a=sh.content;if(i==="svg"||i==="mathml"){const l=a.firstChild;for(;l.firstChild;)a.appendChild(l.firstChild);a.removeChild(l)}e.insertBefore(a,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}},kv=Symbol("_vtc");function Hv(t,e,n){const i=t[kv];i&&(e=(e?[e,...i]:[...i]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}const oh=Symbol("_vod"),zv=Symbol("_vsh"),Vv=Symbol(""),Gv=/(?:^|;)\s*display\s*:/;function Wv(t,e,n){const i=t.style,r=Ot(n);let s=!1;if(n&&!r){if(e)if(Ot(e))for(const o of e.split(";")){const a=o.slice(0,o.indexOf(":")).trim();n[a]==null&&sa(i,a,"")}else for(const o in e)n[o]==null&&sa(i,o,"");for(const o in n)o==="display"&&(s=!0),sa(i,o,n[o])}else if(r){if(e!==n){const o=i[Vv];o&&(n+=";"+o),i.cssText=n,s=Gv.test(n)}}else e&&t.removeAttribute("style");oh in t&&(t[oh]=s?i.display:"",t[zv]&&(i.display="none"))}const ah=/\s*!important$/;function sa(t,e,n){if(Xe(n))n.forEach(i=>sa(t,e,i));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const i=Xv(t,e);ah.test(n)?t.setProperty(Pr(i),n.replace(ah,""),"important"):t[i]=n}}const lh=["Webkit","Moz","ms"],vl={};function Xv(t,e){const n=vl[e];if(n)return n;let i=Dn(e);if(i!=="filter"&&i in t)return vl[e]=i;i=Na(i);for(let r=0;r<lh.length;r++){const s=lh[r]+i;if(s in t)return vl[e]=s}return e}const ch="http://www.w3.org/1999/xlink";function uh(t,e,n,i,r,s=Z_(e)){i&&e.startsWith("xlink:")?n==null?t.removeAttributeNS(ch,e.slice(6,e.length)):t.setAttributeNS(ch,e,n):n==null||s&&!Gp(n)?t.removeAttribute(e):t.setAttribute(e,s?"":Ii(n)?String(n):n)}function fh(t,e,n,i,r){if(e==="innerHTML"||e==="textContent"){n!=null&&(t[e]=e==="innerHTML"?Vm(n):n);return}const s=t.tagName;if(e==="value"&&s!=="PROGRESS"&&!s.includes("-")){const a=s==="OPTION"?t.getAttribute("value")||"":t.value,l=n==null?t.type==="checkbox"?"on":"":String(n);(a!==l||!("_value"in t))&&(t.value=l),n==null&&t.removeAttribute(e),t._value=n;return}let o=!1;if(n===""||n==null){const a=typeof t[e];a==="boolean"?n=Gp(n):n==null&&a==="string"?(n="",o=!0):a==="number"&&(n=0,o=!0)}try{t[e]=n}catch{}o&&t.removeAttribute(r||e)}function Kr(t,e,n,i){t.addEventListener(e,n,i)}function $v(t,e,n,i){t.removeEventListener(e,n,i)}const hh=Symbol("_vei");function qv(t,e,n,i,r=null){const s=t[hh]||(t[hh]={}),o=s[e];if(i&&o)o.value=i;else{const[a,l]=jv(e);if(i){const c=s[e]=Zv(i,r);Kr(t,a,c,l)}else o&&($v(t,a,o,l),s[e]=void 0)}}const dh=/(?:Once|Passive|Capture)$/;function jv(t){let e;if(dh.test(t)){e={};let i;for(;i=t.match(dh);)t=t.slice(0,t.length-i[0].length),e[i[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):Pr(t.slice(2)),e]}let xl=0;const Yv=Promise.resolve(),Kv=()=>xl||(Yv.then(()=>xl=0),xl=Date.now());function Zv(t,e){const n=i=>{if(!i._vts)i._vts=Date.now();else if(i._vts<=n.attached)return;oi(Jv(i,n.value),e,5,[i])};return n.value=t,n.attached=Kv(),n}function Jv(t,e){if(Xe(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(i=>r=>!r._stopped&&i&&i(r))}else return e}const ph=t=>t.charCodeAt(0)===111&&t.charCodeAt(1)===110&&t.charCodeAt(2)>96&&t.charCodeAt(2)<123,Qv=(t,e,n,i,r,s)=>{const o=r==="svg";e==="class"?Hv(t,i,o):e==="style"?Wv(t,n,i):Ia(e)?Lu(e)||qv(t,e,n,i,s):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):ex(t,e,i,o))?(fh(t,e,i),!t.tagName.includes("-")&&(e==="value"||e==="checked"||e==="selected")&&uh(t,e,i,o,s,e!=="value")):t._isVueCE&&(/[A-Z]/.test(e)||!Ot(i))?fh(t,Dn(e),i,s,e):(e==="true-value"?t._trueValue=i:e==="false-value"&&(t._falseValue=i),uh(t,e,i,o))};function ex(t,e,n,i){if(i)return!!(e==="innerHTML"||e==="textContent"||e in t&&ph(e)&&qe(n));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="autocorrect"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const r=t.tagName;if(r==="IMG"||r==="VIDEO"||r==="CANVAS"||r==="SOURCE")return!1}return ph(e)&&Ot(n)?!1:e in t}const mh=t=>{const e=t.props["onUpdate:modelValue"]||!1;return Xe(e)?n=>na(e,n):e};function tx(t){t.target.composing=!0}function gh(t){const e=t.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const Sl=Symbol("_assign"),_h={created(t,{modifiers:{lazy:e,trim:n,number:i}},r){t[Sl]=mh(r);const s=i||r.props&&r.props.type==="number";Kr(t,e?"change":"input",o=>{if(o.target.composing)return;let a=t.value;n&&(a=a.trim()),s&&(a=hc(a)),t[Sl](a)}),n&&Kr(t,"change",()=>{t.value=t.value.trim()}),e||(Kr(t,"compositionstart",tx),Kr(t,"compositionend",gh),Kr(t,"change",gh))},mounted(t,{value:e}){t.value=e??""},beforeUpdate(t,{value:e,oldValue:n,modifiers:{lazy:i,trim:r,number:s}},o){if(t[Sl]=mh(o),t.composing)return;const a=(s||t.type==="number")&&!/^0\d/.test(t.value)?hc(t.value):t.value,l=e??"";a!==l&&(document.activeElement===t&&t.type!=="range"&&(i&&e===n||r&&t.value.trim()===l)||(t.value=l))}},nx=tn({patchProp:Qv},Bv);let vh;function ix(){return vh||(vh=av(nx))}const rx=((...t)=>{const e=ix().createApp(...t),{mount:n}=e;return e.mount=i=>{const r=ox(i);if(!r)return;const s=e._component;!qe(s)&&!s.render&&!s.template&&(s.template=r.innerHTML),r.nodeType===1&&(r.textContent="");const o=n(r,!1,sx(r));return r instanceof Element&&(r.removeAttribute("v-cloak"),r.setAttribute("data-v-app","")),o},e});function sx(t){if(t instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&t instanceof MathMLElement)return"mathml"}function ox(t){return Ot(t)?document.querySelector(t):t}const ax=Gt({name:"a-hoverable",props:{path:{type:String,default:""},href:{type:String,default:""},target:{type:String,default:"_self"},shape:{type:String,default:"center"},effect:{type:String,default:""}}}),fn=(t,e)=>{const n=t.__vccOpts||t;for(const[i,r]of e)n[i]=r;return n},lx=["href","target"];function cx(t,e,n,i,r,s){const o=Ai("router-link");return Je(),at(Ut,null,[t.href?(Je(),at("a",{key:0,class:bn(["a-hoverable",t.shape,t.effect]),href:t.href,target:t.target},[Ea(t.$slots,"default",{},()=>[e[0]||(e[0]=Kt("ERROR",-1))])],10,lx)):ei("",!0),t.path?(Je(),Ys(o,{key:1,class:bn(["a-hoverable",t.shape,t.effect]),to:{name:t.path}},{default:Ft(()=>[Ea(t.$slots,"default",{},()=>[e[1]||(e[1]=Kt("ERROR",-1))],!0)]),_:3},8,["class","to"])):ei("",!0)],64)}const Ju=fn(ax,[["render",cx],["__scopeId","data-v-d4ab219a"]]),ux=Gt({name:"switch-button",props:{isActive:{type:Boolean,default:!1},change:{type:Function,default:()=>{}}}});function fx(t,e,n,i,r,s){return Je(),at("button",{class:"switch",onClick:e[0]||(e[0]=(...o)=>t.change&&t.change(...o))},[ve("div",{class:bn(["option",{active:!t.isActive}])},[Ea(t.$slots,"optionL",{},()=>[e[1]||(e[1]=Kt("IMG ERROR",-1))])],2),ve("div",{class:bn(["option",{active:t.isActive}])},[Ea(t.$slots,"optionR",{},()=>[e[2]||(e[2]=Kt("IMG ERROR",-1))])],2)])}const Gm=fn(ux,[["render",fx],["__scopeId","data-v-e056e1dc"]]);/*!
 * pinia v3.0.3
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let Wm;const $a=t=>Wm=t,Xm=Symbol();function Mc(t){return t&&typeof t=="object"&&Object.prototype.toString.call(t)==="[object Object]"&&typeof t.toJSON!="function"}var Vs;(function(t){t.direct="direct",t.patchObject="patch object",t.patchFunction="patch function"})(Vs||(Vs={}));function hx(){const t=Uu(!0),e=t.run(()=>bt({}));let n=[],i=[];const r=Vu({install(s){$a(r),r._a=s,s.provide(Xm,r),s.config.globalProperties.$pinia=r,i.forEach(o=>n.push(o)),i=[]},use(s){return this._a?n.push(s):i.push(s),this},_p:n,_a:null,_e:t,_s:new Map,state:e});return r}const $m=()=>{};function xh(t,e,n,i=$m){t.push(e);const r=()=>{const s=t.indexOf(e);s>-1&&(t.splice(s,1),i())};return!n&&qp()&&J_(r),r}function Ur(t,...e){t.slice().forEach(n=>{n(...e)})}const dx=t=>t(),Sh=Symbol(),yl=Symbol();function bc(t,e){t instanceof Map&&e instanceof Map?e.forEach((n,i)=>t.set(i,n)):t instanceof Set&&e instanceof Set&&e.forEach(t.add,t);for(const n in e){if(!e.hasOwnProperty(n))continue;const i=e[n],r=t[n];Mc(r)&&Mc(i)&&t.hasOwnProperty(n)&&!Lt(i)&&!ji(i)?t[n]=bc(r,i):t[n]=i}return t}const px=Symbol();function mx(t){return!Mc(t)||!Object.prototype.hasOwnProperty.call(t,px)}const{assign:Vi}=Object;function gx(t){return!!(Lt(t)&&t.effect)}function _x(t,e,n,i){const{state:r,actions:s,getters:o}=e,a=n.state.value[t];let l;function c(){a||(n.state.value[t]=r?r():{});const u=S0(n.state.value[t]);return Vi(u,s,Object.keys(o||{}).reduce((f,h)=>(f[h]=Vu(Bt(()=>{$a(n);const p=n._s.get(t);return o[h].call(p,p)})),f),{}))}return l=qm(t,c,e,n,i,!0),l}function qm(t,e,n={},i,r,s){let o;const a=Vi({actions:{}},n),l={deep:!0};let c,u,f=[],h=[],p;const _=i.state.value[t];!s&&!_&&(i.state.value[t]={}),bt({});let v;function m(O){let A;c=u=!1,typeof O=="function"?(O(i.state.value[t]),A={type:Vs.patchFunction,storeId:t,events:p}):(bc(i.state.value[t],O),A={type:Vs.patchObject,payload:O,storeId:t,events:p});const T=v=Symbol();Wu().then(()=>{v===T&&(c=!0)}),u=!0,Ur(f,A,i.state.value[t])}const d=s?function(){const{state:A}=n,T=A?A():{};this.$patch(F=>{Vi(F,T)})}:$m;function S(){o.stop(),f=[],h=[],i._s.delete(t)}const E=(O,A="")=>{if(Sh in O)return O[yl]=A,O;const T=function(){$a(i);const F=Array.from(arguments),Y=[],q=[];function oe(J){Y.push(J)}function ae(J){q.push(J)}Ur(h,{args:F,name:T[yl],store:P,after:oe,onError:ae});let te;try{te=O.apply(this&&this.$id===t?this:P,F)}catch(J){throw Ur(q,J),J}return te instanceof Promise?te.then(J=>(Ur(Y,J),J)).catch(J=>(Ur(q,J),Promise.reject(J))):(Ur(Y,te),te)};return T[Sh]=!0,T[yl]=A,T},x={_p:i,$id:t,$onAction:xh.bind(null,h),$patch:m,$reset:d,$subscribe(O,A={}){const T=xh(f,O,A.detached,()=>F()),F=o.run(()=>wi(()=>i.state.value[t],Y=>{(A.flush==="sync"?u:c)&&O({storeId:t,type:Vs.direct,events:p},Y)},Vi({},l,A)));return T},$dispose:S},P=ho(x);i._s.set(t,P);const R=(i._a&&i._a.runWithContext||dx)(()=>i._e.run(()=>(o=Uu()).run(()=>e({action:E}))));for(const O in R){const A=R[O];if(Lt(A)&&!gx(A)||ji(A))s||(_&&mx(A)&&(Lt(A)?A.value=_[O]:bc(A,_[O])),i.state.value[t][O]=A);else if(typeof A=="function"){const T=E(A,O);R[O]=T,a.actions[O]=A}}return Vi(P,R),Vi(st(P),R),Object.defineProperty(P,"$state",{get:()=>i.state.value[t],set:O=>{m(A=>{Vi(A,O)})}}),i._p.forEach(O=>{Vi(P,o.run(()=>O({store:P,app:i._a,pinia:i,options:a})))}),_&&s&&n.hydrate&&n.hydrate(P.$state,_),c=!0,u=!0,P}/*! #__NO_SIDE_EFFECTS__ */function Qu(t,e,n){let i;const r=typeof e=="function";i=r?n:e;function s(o,a){const l=ev();return o=o||(l?Gn(Xm,null):null),o&&$a(o),o=Wm,o._s.has(t)||(r?qm(t,e,i,o):_x(t,i,o)),o._s.get(t)}return s.$id=t,s}const vx=["light","dark"],qa=Qu("theme",()=>{const t=localStorage.getItem("theme"),e=bt(vx.includes(t)?t:"light");Va(()=>{localStorage.setItem("theme",e.value)});const n=Bt(()=>e.value==="dark");function i(){switch(e.value){case"light":e.value="dark";break;case"dark":e.value="light";break}}return{theme:e,isDark:n,changeTheme:i}});/*!
  * shared v11.1.11
  * (c) 2025 kazuya kawaguchi
  * Released under the MIT License.
  */function xx(t,e){typeof console<"u"&&(console.warn("[intlify] "+t),e&&console.warn(e.stack))}const Aa=typeof window<"u",tr=(t,e=!1)=>e?Symbol.for(t):Symbol(t),Sx=(t,e,n)=>yx({l:t,k:e,s:n}),yx=t=>JSON.stringify(t).replace(/\u2028/g,"\\u2028").replace(/\u2029/g,"\\u2029").replace(/\u0027/g,"\\u0027"),Nt=t=>typeof t=="number"&&isFinite(t),Ex=t=>ef(t)==="[object Date]",ls=t=>ef(t)==="[object RegExp]",ja=t=>Qe(t)&&Object.keys(t).length===0,kt=Object.assign,Mx=Object.create,xt=(t=null)=>Mx(t);let yh;const Sr=()=>yh||(yh=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:xt());function Eh(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&apos;").replace(/\//g,"&#x2F;").replace(/=/g,"&#x3D;")}function Mh(t){return t.replace(/&(?![a-zA-Z0-9#]{2,6};)/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&apos;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function bx(t){return t=t.replace(/(\w+)\s*=\s*"([^"]*)"/g,(i,r,s)=>`${r}="${Mh(s)}"`),t=t.replace(/(\w+)\s*=\s*'([^']*)'/g,(i,r,s)=>`${r}='${Mh(s)}'`),/\s*on\w+\s*=\s*["']?[^"'>]+["']?/gi.test(t)&&(t=t.replace(/(\s+)(on)(\w+\s*=)/gi,"$1&#111;n$3")),[/(\s+(?:href|src|action|formaction)\s*=\s*["']?)\s*javascript:/gi,/(style\s*=\s*["'][^"']*url\s*\(\s*)javascript:/gi].forEach(i=>{t=t.replace(i,"$1javascript&#58;")}),t}const Tx=Object.prototype.hasOwnProperty;function Hn(t,e){return Tx.call(t,e)}const Ct=Array.isArray,Et=t=>typeof t=="function",Le=t=>typeof t=="string",lt=t=>typeof t=="boolean",ut=t=>t!==null&&typeof t=="object",Ax=t=>ut(t)&&Et(t.then)&&Et(t.catch),jm=Object.prototype.toString,ef=t=>jm.call(t),Qe=t=>ef(t)==="[object Object]",wx=t=>t==null?"":Ct(t)||Qe(t)&&t.toString===jm?JSON.stringify(t,null,2):String(t);function tf(t,e=""){return t.reduce((n,i,r)=>r===0?n+i:n+e+i,"")}const Lo=t=>!ut(t)||Ct(t);function oa(t,e){if(Lo(t)||Lo(e))throw new Error("Invalid value");const n=[{src:t,des:e}];for(;n.length;){const{src:i,des:r}=n.pop();Object.keys(i).forEach(s=>{s!=="__proto__"&&(ut(i[s])&&!ut(r[s])&&(r[s]=Array.isArray(i[s])?[]:xt()),Lo(r[s])||Lo(i[s])?r[s]=i[s]:n.push({src:i[s],des:r[s]}))})}}/*!
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Yi,depthTest:!1,depthWrite:!1})}function np(){return new er({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Rf(),fragmentShader:`
		...
		`,blending:Yi,depthTest:!1,depthWrite:!1})}function ip(){return new er({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Rf(),fragmentShader:`
	...
	`}function _A(t){let e=new WeakMap,n=null;function i(a){if(a&&a.isTexture){const l=a.mapping,c=l===qc||l===jc,u=l===ds||l===ps;if(c||u){let f=e.get(a);const h=f!==void 0?f.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==h)return n===null&&(n=new ep(t)),f=c?n.fromEquirectangular(a,f):n.fromCubemap(a,f),f.texture.pmremVersion=a.pmremVersion,e.set(a,f),f.texture;if(f!==void 0)return f.texture;{const p=a.image;return c&&p&&p.height>0||u&&p&&r(p)?(n===null&&(n=new ep(t)),f=c?n.fromEquirectangular(a):n.fromCubemap(a),f.texture.pmremVersion=a.pmremVersion,e.set(a,f),a.addEventListener("dispose",s),f.texture):null}}}return a}function r(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:i,dispose:o}}function vA(t){const e={};function n(i){if(e[i]!==void 0)return e[i];let r;switch(i){case"WEBGL_depth_texture":r=t.getExtension("WEBGL_depth_texture")||t.getExtension("MOZ_WEBGL_depth_texture")||t.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=t.getExtension("EXT_texture_filter_anisotropic")||t.getExtension("MOZ_EXT_texture_filter_anisotropic")||t.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=t.getExtension("WEBGL_compressed_texture_s3tc")||t.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||t.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=t.getExtension("WEBGL_compressed_texture_pvrtc")||t.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=t.getExtension(i)}return e[i]=r,r}return{has:function(i){return n(i)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(i){const r=n(i);return r===null&&ss("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function xA(t,e,n,i){const r={},s=new WeakMap;function o(f){const h=f.target;h.index!==null&&e.remove(h.index);for(const _ in h.attributes)e.remove(h.attributes[_]);h.removeEventListener("dispose",o),delete r[h.id];const p=s.get(h);p&&(e.remove(p),s.delete(h)),i.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,n.memory.geometries--}function a(f,h){return r[h.id]===!0||(h.addEventListener("dispose",o),r[h.id]=!0,n.memory.geometries++),h}function l(f){const h=f.attributes;for(const p in h)e.update(h[p],t.ARRAY_BUFFER)}function c(f){const h=[],p=f.index,_=f.attributes.position;let v=0;if(p!==null){const S=p.array;v=p.version;for(let E=0,x=S.length;E<x;E+=3){const P=S[E+0],I=S[E+1],R=S[E+2];h.push(P,I,I,R,R,P)}}else if(_!==void 0){const S=_.array;v=_.version;for(let E=0,x=S.length/3-1;E<x;E+=3){const P=E+0,I=E+1,R=E+2;h.push(P,I,I,R,R,P)}}else return;const m=new(qg(h)?Jg:Zg)(h,1);m.version=v;const d=s.get(f);d&&e.remove(d),s.set(f,m)}function u(f){const h=s.get(f);if(h){const p=f.index;p!==null&&h.version<p.version&&c(f)}else c(f);return s.get(f)}return{get:a,update:l,getWireframeAttribute:u}}function SA(t,e,n){let i;function r(h){i=h}let s,o;function a(h){s=h.type,o=h.bytesPerElement}function l(h,p){t.drawElements(i,p,s,h*o),n.update(p,i,1)}function c(h,p,_){_!==0&&(t.drawElementsInstanced(i,p,s,h*o,_),n.update(p,i,_))}function u(h,p,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,p,0,s,h,0,_);let m=0;for(let d=0;d<_;d++)m+=p[d];n.update(m,i,1)}function f(h,p,_,v){if(_===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<h.length;d++)c(h[d]/o,p[d],v[d]);else{m.multiDrawElementsInstancedWEBGL(i,p,0,s,h,0,v,0,_);let d=0;for(let S=0;S<_;S++)d+=p[S]*v[S];n.update(d,i,1)}}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=f}function yA(t){const e={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(n.calls++,o){case t.TRIANGLES:n.triangles+=a*(s/3);break;case t.LINES:n.lines+=a*(s/2);break;case t.LINE_STRIP:n.lines+=a*(s-1);break;case t.LINE_LOOP:n.lines+=a*s;break;case t.POINTS:n.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:e,render:n,programs:null,autoReset:!0,reset:r,update:i}}function EA(t,e,n){const i=new WeakMap,r=new Pt;function s(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,f=u!==void 0?u.length:0;let h=i.get(a);if(h===void 0||h.count!==f){let T=function(){O.dispose(),i.delete(a),a.removeEventListener("dispose",T)};var p=T;h!==void 0&&h.texture.dispose();const _=a.morphAttributes.position!==void 0,v=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,d=a.morphAttributes.position||[],S=a.morphAttributes.normal||[],E=a.morphAttributes.color||[];let x=0;_===!0&&(x=1),v===!0&&(x=2),m===!0&&(x=3);let P=a.attributes.position.count*x,I=1;P>e.maxTextureSize&&(I=Math.ceil(P/e.maxTextureSize),P=e.maxTextureSize);const R=new Float32Array(P*I*4*f),O=new jg(R,P,I,f);O.type=bi,O.needsUpdate=!0;const A=x*4;for(let F=0;F<f;F++){const Y=d[F],q=S[F],oe=E[F],ae=P*I*4*F;for(let te=0;te<Y.count;te++){const J=te*A;_===!0&&(r.fromBufferAttribute(Y,te),R[ae+J+0]=r.x,R[ae+J+1]=r.y,R[ae+J+2]=r.z,R[ae+J+3]=0),v===!0&&(r.fromBufferAttribute(q,te),R[ae+J+4]=r.x,R[ae+J+5]=r.y,R[ae+J+6]=r.z,R[ae+J+7]=0),m===!0&&(r.fromBufferAttribute(oe,te),R[ae+J+8]=r.x,R[ae+J+9]=r.y,R[ae+J+10]=r.z,R[ae+J+11]=oe.itemSize===4?r.w:1)}}h={count:f,texture:O,size:new it(P,I)},i.set(a,h),a.addEventListener("dispose",T)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(t,"morphTexture",o.morphTexture,n);else{let _=0;for(let m=0;m<c.length;m++)_+=c[m];const v=a.morphTargetsRelative?1:1-_;l.getUniforms().setValue(t,"morphTargetBaseInfluence",v),l.getUniforms().setValue(t,"morphTargetInfluences",c)}l.getUniforms().setValue(t,"morphTargetsTexture",h.texture,n),l.getUniforms().setValue(t,"morphTargetsTextureSize",h.size)}return{update:s}}function MA(t,e,n,i){let r=new WeakMap;function s(l){const c=i.render.frame,u=l.geometry,f=e.get(l,u);if(r.get(f)!==c&&(e.update(f),r.set(f,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==c&&(n.update(l.instanceMatrix,t.ARRAY_BUFFER),l.instanceColor!==null&&n.update(l.instanceColor,t.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const h=l.skeleton;r.get(h)!==c&&(h.update(),r.set(h,c))}return f}function o(){r=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),n.remove(c.instanceMatrix),c.instanceColor!==null&&n.remove(c.instanceColor)}return{update:s,dispose:o}}const o_=new un,rp=new n_(1,1),a_=new jg,l_=new WM,c_=new t_,sp=[],op=[],ap=new Float32Array(16),lp=new Float32Array(9),cp=new Float32Array(4);function Ss(t,e,n){const i=t[0];if(i<=0||i>0)return t;const r=e*n;let s=sp[r];if(s===void 0&&(s=new Float32Array(r),sp[r]=s),e!==0){i.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=n,t[o].toArray(s,a)}return s}function Ht(t,e){if(t.length!==e.length)return!1;for(let n=0,i=t.length;n<i;n++)if(t[n]!==e[n])return!1;return!0}function zt(t,e){for(let n=0,i=e.length;n<i;n++)t[n]=e[n]}function el(t,e){let n=op[e];n===void 0&&(n=new Int32Array(e),op[e]=n);for(let i=0;i!==e;++i)n[i]=t.allocateTextureUnit();return n}function bA(t,e){const n=this.cache;n[0]!==e&&(t.uniform1f(this.addr,e),n[0]=e)}function TA(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2f(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Ht(n,e))return;t.uniform2fv(this.addr,e),zt(n,e)}}function AA(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3f(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else if(e.r!==void 0)(n[0]!==e.r||n[1]!==e.g||n[2]!==e.b)&&(t.uniform3f(this.addr,e.r,e.g,e.b),n[0]=e.r,n[1]=e.g,n[2]=e.b);else{if(Ht(n,e))return;t.uniform3fv(this.addr,e),zt(n,e)}}function wA(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4f(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Ht(n,e))return;t.uniform4fv(this.addr,e),zt(n,e)}}function RA(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Ht(n,e))return;t.uniformMatrix2fv(this.addr,!1,e),zt(n,e)}else{if(Ht(n,i))return;cp.set(i),t.uniformMatrix2fv(this.addr,!1,cp),zt(n,i)}}function CA(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Ht(n,e))return;t.uniformMatrix3fv(this.addr,!1,e),zt(n,e)}else{if(Ht(n,i))return;lp.set(i),t.uniformMatrix3fv(this.addr,!1,lp),zt(n,i)}}function PA(t,e){const n=this.cache,i=e.elements;if(i===void 0){if(Ht(n,e))return;t.uniformMatrix4fv(this.addr,!1,e),zt(n,e)}else{if(Ht(n,i))return;ap.set(i),t.uniformMatrix4fv(this.addr,!1,ap),zt(n,i)}}function LA(t,e){const n=this.cache;n[0]!==e&&(t.uniform1i(this.addr,e),n[0]=e)}function IA(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2i(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Ht(n,e))return;t.uniform2iv(this.addr,e),zt(n,e)}}function DA(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3i(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(Ht(n,e))return;t.uniform3iv(this.addr,e),zt(n,e)}}function UA(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4i(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Ht(n,e))return;t.uniform4iv(this.addr,e),zt(n,e)}}function NA(t,e){const n=this.cache;n[0]!==e&&(t.uniform1ui(this.addr,e),n[0]=e)}function OA(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y)&&(t.uniform2ui(this.addr,e.x,e.y),n[0]=e.x,n[1]=e.y);else{if(Ht(n,e))return;t.uniform2uiv(this.addr,e),zt(n,e)}}function FA(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z)&&(t.uniform3ui(this.addr,e.x,e.y,e.z),n[0]=e.x,n[1]=e.y,n[2]=e.z);else{if(Ht(n,e))return;t.uniform3uiv(this.addr,e),zt(n,e)}}function BA(t,e){const n=this.cache;if(e.x!==void 0)(n[0]!==e.x||n[1]!==e.y||n[2]!==e.z||n[3]!==e.w)&&(t.uniform4ui(this.addr,e.x,e.y,e.z,e.w),n[0]=e.x,n[1]=e.y,n[2]=e.z,n[3]=e.w);else{if(Ht(n,e))return;t.uniform4uiv(this.addr,e),zt(n,e)}}function kA(t,e,n){const i=this.cache,r=n.allocateTextureUnit();i[0]!==r&&(t.uniform1i(this.addr,r),i[0]=r);let s;this.type===t.SAMPLER_2D_SHADOW?(rp.compareFunction=$g,s=rp):s=o_,n.setTexture2D(e||s,r)}function HA(t,e,n){const i=this.cache,r=n.allocateTextureUnit();i[0]!==r&&(t.uniform1i(this.addr,r),i[0]=r),n.setTexture3D(e||l_,r)}function zA(t,e,n){const i=this.cache,r=n.allocateTextureUnit();i[0]!==r&&(t.uniform1i(this.addr,r),i[0]=r),n.setTextureCube(e||c_,r)}function VA(t,e,n){const i=this.cache,r=n.allocateTextureUnit();i[0]!==r&&(t.uniform1i(this.addr,r),i[0]=r),n.setTexture2DArray(e||a_,r)}function GA(t){switch(t){case 5126:return bA;case 35664:return TA;case 35665:return AA;case 35666:return wA;case 35674:return RA;case 35675:return CA;case 35676:return PA;case 5124:case 35670:return LA;case 35667:case 35671:return IA;case 35668:case 35672:return DA;case 35669:case 35673:return UA;case 5125:return NA;case 36294:return OA;case 36295:return FA;case 36296:return BA;case 35678:case 36198:case 36298:case 36306:case 35682:return kA;case 35679:case 36299:case 36307:return HA;case 35680:case 36300:case 36308:case 36293:return zA;case 36289:case 36303:case 36311:case 36292:return VA}}function WA(t,e){t.uniform1fv(this.addr,e)}function XA(t,e){const n=Ss(e,this.size,2);t.uniform2fv(this.addr,n)}function $A(t,e){const n=Ss(e,this.size,3);t.uniform3fv(this.addr,n)}function qA(t,e){const n=Ss(e,this.size,4);t.uniform4fv(this.addr,n)}function jA(t,e){const n=Ss(e,this.size,4);t.uniformMatrix2fv(this.addr,!1,n)}function YA(t,e){const n=Ss(e,this.size,9);t.uniformMatrix3fv(this.addr,!1,n)}function KA(t,e){const n=Ss(e,this.size,16);t.uniformMatrix4fv(this.addr,!1,n)}function ZA(t,e){t.uniform1iv(this.addr,e)}function JA(t,e){t.uniform2iv(this.addr,e)}function QA(t,e){t.uniform3iv(this.addr,e)}function ew(t,e){t.uniform4iv(this.addr,e)}function tw(t,e){t.uniform1uiv(this.addr,e)}function nw(t,e){t.uniform2uiv(this.addr,e)}function iw(t,e){t.uniform3uiv(this.addr,e)}function rw(t,e){t.uniform4uiv(this.addr,e)}function sw(t,e,n){const i=this.cache,r=e.length,s=el(n,r);Ht(i,s)||(t.uniform1iv(this.addr,s),zt(i,s));for(let o=0;o!==r;++o)n.setTexture2D(e[o]||o_,s[o])}function ow(t,e,n){const i=this.cache,r=e.length,s=el(n,r);Ht(i,s)||(t.uniform1iv(this.addr,s),zt(i,s));for(let o=0;o!==r;++o)n.setTexture3D(e[o]||l_,s[o])}function aw(t,e,n){const i=this.cache,r=e.length,s=el(n,r);Ht(i,s)||(t.uniform1iv(this.addr,s),zt(i,s));for(let o=0;o!==r;++o)n.setTextureCube(e[o]||c_,s[o])}function lw(t,e,n){const i=this.cache,r=e.length,s=el(n,r);Ht(i,s)||(t.uniform1iv(this.addr,s),zt(i,s));for(let o=0;o!==r;++o)n.setTexture2DArray(e[o]||a_,s[o])}function cw(t){switch(t){case 5126:return WA;case 35664:return XA;case 35665:return $A;case 35666:return qA;case 35674:return jA;case 35675:return YA;case 35676:return KA;case 5124:case 35670:return ZA;case 35667:case 35671:return JA;case 35668:case 35672:return QA;case 35669:case 35673:return ew;case 5125:return tw;case 36294:return nw;case 36295:return iw;case 36296:return rw;case 35678:case 36198:case 36298:case 36306:case 35682:return sw;case 35679:case 36299:case 36307:return ow;case 35680:case 36300:case 36308:case 36293:return aw;case 36289:case 36303:case 36311:case 36292:return lw}}class uw{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.setValue=GA(n.type)}}class fw{constructor(e,n,i){this.id=e,this.addr=i,this.cache=[],this.type=n.type,this.size=n.size,this.setValue=cw(n.type)}}class hw{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,n,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,n[a.id],i)}}}const sc=/(\w+)(\])?(\[|\.)?/g;function up(t,e){t.seq.push(e),t.map[e.id]=e}function dw(t,e,n){const i=t.name,r=i.length;for(sc.lastIndex=0;;){const s=sc.exec(i),o=sc.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){up(n,c===void 0?new uw(a,t,e):new fw(a,t,e));break}else{let f=n.map[a];f===void 0&&(f=new hw(a),up(n,f)),n=f}}}class ha{constructor(e,n){this.seq=[],this.map={};const i=e.getProgramParameter(n,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(n,r),o=e.getUniformLocation(n,s.name);dw(s,o,this)}}setValue(e,n,i,r){const s=this.map[n];s!==void 0&&s.setValue(e,i,r)}setOptional(e,n,i){const r=n[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,n,i,r){for(let s=0,o=n.length;s!==o;++s){const a=n[s],l=i[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,n){const i=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in n&&i.push(o)}return i}}function fp(t,e,n){const i=t.createShader(e);return t.shaderSource(i,n),t.compileShader(i),i}const pw=37297;let mw=0;function gw(t,e){const n=t.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,n.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${n[o]}`)}return i.join(`
`)}const hp=new Ye;function _w(t){ot._getMatrix(hp,ot.workingColorSpace,t);const e=`mat3( ${hp.elements.map(n=>n.toFixed(4))} )`;switch(ot.getTransfer(t)){case wa:return[e,"LinearTransferOETF"];case _t:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",t),[e,"LinearTransferOETF"]}}function dp(t,e,n){const i=t.getShaderParameter(e,t.COMPILE_STATUS),r=t.getShaderInfoLog(e).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return n.toUpperCase()+`

`+r+`

`+gw(t.getShaderSource(e),o)}else return r}function vw(t,e){const n=_w(e);return[`vec4 ${t}( vec4 value ) {`,`	return ${n[1]}( vec4( value.rgb * ${n[0]}, value.a ) );`,"}"].join(`
`)}function xw(t,e){let n;switch(e){case gM:n="Linear";break;case _M:n="Reinhard";break;case vM:n="Cineon";break;case xM:n="ACESFilmic";break;case yM:n="AgX";break;case EM:n="Neutral";break;case SM:n="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),n="Linear"}return"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const ta=new $;function Sw(){ot.getLuminanceCoefficients(ta);const t=ta.x.toFixed(4),e=ta.y.toFixed(4),n=ta.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
`)}function yw(t){return[t.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",t.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ns).join(`
`)}function Ew(t){const e=[];for(const n in t){const i=t[n];i!==!1&&e.push("#define "+n+" "+i)}return e.join(`
`)}function Mw(t,e){const n={},i=t.getProgramParameter(e,t.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=t.getActiveAttrib(e,r),o=s.name;let a=1;s.type===t.FLOAT_MAT2&&(a=2),s.type===t.FLOAT_MAT3&&(a=3),s.type===t.FLOAT_MAT4&&(a=4),n[o]={type:s.type,location:t.getAttribLocation(e,o),locationSize:a}}return n}function Ns(t){return t!==""}function pp(t,e){const n=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return t.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,n).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function mp(t,e){return t.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const bw=/^[ \t]*#include +<([\w\d./]+)>/gm;function Mu(t){return t.replace(bw,Aw)}const Tw=new Map;function Aw(t,e){let n=Ke[e];if(n===void 0){const i=Tw.get(e);if(i!==void 0)n=Ke[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return Mu(n)}const ww=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function gp(t){return t.replace(ww,Rw)}function Rw(t,e,n,i){let r="";for(let s=parseInt(e);s<parseInt(n);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function _p(t){let e=`precision ${t.precision} float;
...
#define LOW_PRECISION`),e}function Cw(t){let e="SHADOWMAP_TYPE_BASIC";return t.shadowMapType===Ng?e="SHADOWMAP_TYPE_PCF":t.shadowMapType===Og?e="SHADOWMAP_TYPE_PCF_SOFT":t.shadowMapType===_i&&(e="SHADOWMAP_TYPE_VSM"),e}function Pw(t){let e="ENVMAP_TYPE_CUBE";if(t.envMap)switch(t.envMapMode){case ds:case ps:e="ENVMAP_TYPE_CUBE";break;case Qa:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Lw(t){let e="ENVMAP_MODE_REFLECTION";if(t.envMap)switch(t.envMapMode){case ps:e="ENVMAP_MODE_REFRACTION";break}return e}function Iw(t){let e="ENVMAP_BLENDING_NONE";if(t.envMap)switch(t.combine){case Ja:e="ENVMAP_BLENDING_MULTIPLY";break;case pM:e="ENVMAP_BLENDING_MIX";break;case mM:e="ENVMAP_BLENDING_ADD";break}return e}function Dw(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),112)),texelHeight:i,maxMip:n}}function Uw(t,e,n,i){const r=t.getContext(),s=n.defines;let o=n.vertexShader,a=n.fragmentShader;const l=Cw(n),c=Pw(n),u=Lw(n),f=Iw(n),h=Dw(n),p=yw(n),_=Ew(s),v=r.createProgram();let m,d,S=n.glslVersion?"#version "+n.glslVersion+`

...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Yi,depthTest:!1,depthWrite:!1})}function tp(){return new er({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Rf(),fragmentShader:`
		...
		`,blending:Yi,depthTest:!1,depthWrite:!1})}function np(){return new er({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Rf(),fragmentShader:`
...
`].filter(Ns).join(`
`)),o=bu(o),o=dp(o,n),o=pp(o,n),a=bu(a),a=dp(a,n),a=pp(a,n),o=mp(o),a=mp(a),n.isRawShaderMaterial!==!0&&(S=`#version 300 es

...
`)}function C1(t,e){let n;switch(e){case LM:n="Linear";break;case IM:n="Reinhard";break;case DM:n="Cineon";break;case UM:n="ACESFilmic";break;case OM:n="AgX";break;case FM:n="Neutral";break;case NM:n="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),n="Linear"}return"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const aa=new q;function P1(){lt.getLuminanceCoefficients(aa);const t=aa.x.toFixed(4),e=aa.y.toFixed(4),n=aa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`

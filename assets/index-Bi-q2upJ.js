...
#define LOW_PRECISION`),e}function Xw(t){let e="SHADOWMAP_TYPE_BASIC";return t.shadowMapType===Gm?e="SHADOWMAP_TYPE_PCF":t.shadowMapType===Wm?e="SHADOWMAP_TYPE_PCF_SOFT":t.shadowMapType===li&&(e="SHADOWMAP_TYPE_VSM"),e}function $w(t){let e="ENVMAP_TYPE_CUBE";if(t.envMap)switch(t.envMapMode){case cs:case us:e="ENVMAP_TYPE_CUBE";break;case Oo:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Yw(t){let e="ENVMAP_MODE_REFLECTION";if(t.envMap)switch(t.envMapMode){case us:e="ENVMAP_MODE_REFRACTION";break}return e}function qw(t){let e="ENVMAP_BLENDING_NONE";if(t.envMap)switch(t.combine){case Fo:e="ENVMAP_BLENDING_MULTIPLY";break;case dy:e="ENVMAP_BLENDING_MIX";break;case py:e="ENVMAP_BLENDING_ADD";break}return e}function jw(t){const e=t.envMapCubeUVHeight;if(e===null)return null;const n=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,n),112)),texelHeight:i,maxMip:n}}function Kw(t,e,n,i){const r=t.getContext(),s=n.defines;let a=n.vertexShader,o=n.fragmentShader;const l=Xw(n),c=$w(n),u=Yw(n),f=qw(n),d=jw(n),p=Ow(n),_=Bw(s),x=r.createProgram();let g,h,M=n.glslVersion?"#version "+n.glslVersion+`
...
`].filter(Us).join(`
`)),a=Jc(a),a=Ud(a,n),a=Nd(a,n),o=Jc(o),o=Ud(o,n),o=Nd(o,n),a=Fd(a),o=Fd(o),n.isRawShaderMaterial!==!0&&(M=`#version 300 es

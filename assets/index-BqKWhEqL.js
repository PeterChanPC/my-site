...
`)+`
`+h);const E=S+m+o,x=S+h+a,C=fp(r,r.VERTEX_SHADER,E),L=fp(r,r.FRAGMENT_SHADER,x);r.attachShader(v,C),r.attachShader(v,L),n.index0AttributeName!==void 0?r.bindAttribLocation(v,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(v,0,"position"),r.linkProgram(v);function A(F){if(t.debug.checkShaderErrors){const $=r.getProgramInfoLog(v).trim(),q=r.getShaderInfoLog(C).trim(),ae=r.getShaderInfoLog(L).trim();let se=!0,Q=!0;if(r.getProgramParameter(v,r.LINK_STATUS)===!1)if(se=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,v,C,L);else{const K=hp(r,C,"vertex"),W=hp(r,L,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(v,r.VALIDATE_STATUS)+`
